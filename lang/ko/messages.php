...
return [
    ...
    'how_step2_desc' => '브라우저가 임의의 키를 생성하고 <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>를 통해 <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a>으로 콘텐츠를 로컬에서 암호화합니다. 서버는 암호화된 데이터만 받습니다.',
    ...
    'faq_a5' => '브라우저가 무작위 키를 생성하고 NIST가 권장하는 <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a> 알고리즘을 W3C의 <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>를 통해 콘텐츠를 로컬에서 암호화합니다. 서버는 암호화된 데이터만 받으며, 평문을 볼 수 없습니다.',
    ...
    'sbd_zk_title' => '제로 지식',
    'sbd_zk_desc' => '서버는 암호화 키를 받지 않습니다 — <a href="https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">OWASP 암호화 저장소</a> 원칙을 준수합니다. 데이터베이스가 침해되어도 공격자가 얻는 것은 무의미한 노이즈뿐입니다. 약속이 아닙니다 — 수학적 불가능성입니다.',
    ...
    'usecase1_tip' => '만료 1시간, 1회 읽기. 링크가 제시간에 열리지 않으면 비밀번호를 변경하세요.',
