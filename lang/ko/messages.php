...
return [
    ...
    'faq_a2' => '아니요. Secret Drop은 제로 지식 아키텍처를 사용합니다. 복호화 키는 URL 프래그먼트(# 뒤)에 배치되며, 서버로 전송되지 않습니다.',
    'faq_q3' => 'Secret Drop을 사용하려면 계정이 필요한가요?',
    'faq_a3' => '아니요. 회원가입이 필요 없으며 사용자를 추적하지 않습니다. 비밀은 익명이며 사용자와 연결할 수 없습니다.',
    'faq_q4' => '비밀이 읽힌 후에는 어떻게 되나요?',
    'faq_a4' => '조회 제한에 도달하면 암호화된 콘텐츠는 서버에서 영구적으로 파괴됩니다. 비밀이 존재했고 소비되었다는 증거로 메타데이터(생성 날짜, 조회 수)만 유지됩니다. 누군가 링크와 키를 가로채더라도 비밀은 이미 사라졌습니다 — 복호화할 것이 없습니다.',
    'faq_q5' => 'Secret Drop은 무료인가요?',
    'faq_a5' => '네, Secret Drop은 완전히 무료입니다. 계정 등록, 구독, 숨겨진 비용이 없습니다. 누구나 제한 없이 이용할 수 있습니다.',
    'faq_q6' => '파일 최대 크기는 얼마인가요?',
    'faq_a6' => '최대 10MB의 파일과 최대 50,000자의 텍스트 메시지를 공유할 수 있습니다. 파일은 업로드 전에 브라우저에서 암호화됩니다.',
    'faq_q7' => '데이터는 어디에 저장되나요?',
    'faq_a7' => '모든 데이터는 프랑스에 위치한 서버에 저장됩니다. 암호화된 데이터만 보관되며, 서버는 비밀의 평문 내용에 접근할 수 없습니다.',
    'faq_q8' => 'Secret Drop은 GDPR을 준수하나요?',
    'faq_a8' => '네, 설계부터 준수합니다. Secret Drop은 제로 지식 암호화를 사용하고, 사용자를 추적하지 않으며, 광고 쿠키를 사용하지 않고, 만료된 데이터를 자동으로 삭제합니다. 개인 데이터가 평문으로 저장되지 않습니다.',
    'faq_q9' => '비밀번호를 안전하게 공유하려면 어떻게 하나요?',
    'faq_a9' => '비밀번호를 붙여넣고, 만료 시간을 선택하고, 선택적으로 1회 열람으로 제한합니다. Secret Drop이 브라우저에서 암호화하고 공유할 수 있는 안전한 링크를 생성합니다. 비밀번호는 서버에 노출되지 않습니다.',
    'faq_q10' => 'Secret Drop은 오픈 소스인가요?',
    'faq_a10' => '네, Secret Drop은 GNU Affero General Public License v3(AGPL-3.0) 오픈 소스입니다. 암호화 로직을 검사하고, 백도어가 없는지 확인하고, 제로 지식 아키텍처가 설명대로 작동하는지 검증할 수 있습니다.',
    'faq_q11' => 'Secret Drop과 암호화된 이메일의 차이점은 무엇인가요?',
    'faq_a11' => '암호화된 이메일(PGP, S/MIME)은 양측이 사전에 키를 설정해야 하며 복잡합니다. Secret Drop은 수신자에게 아무것도 요구하지 않습니다 — 링크만 있으면 됩니다. 또한 비밀은 열람 후 자동으로 소멸되어 흔적을 남기지 않지만, 이메일은 양쪽 수신함에 무기한 남아 있습니다.',
    'faq_q12' => '비밀을 만든 후 어떻게 관리하나요?',
    'faq_a12' => '비밀 생성 시 이메일을 입력했다면 "관리" 링크를 통해 비밀을 관리(취소, 연장)할 수 있습니다. 이메일을 입력하면 10분간 유효한 일회용 링크를 받게 됩니다. 이 매직 링크는 의도적인 보안 선택입니다. 비밀번호가 없으면 도난, 유출 또는 무차별 대입 공격의 대상이 없습니다. 이메일이 유일한 인증 수단이 됩니다 — 간단하고 안전합니다.',
    ...
    'sbd_zk_title' => '제로 지식: 약속이 아닌 수학적 불가능성',
    'sbd_zk_desc' => '서버는 암호화 키를 받지 않습니다. 데이터베이스가 침해되어도 공격자는 쓸모없는 암호문만 얻습니다. 이것은 개인정보 보호 정책이 아니라 수학적 불가능성입니다.',
    'sbd_ml_title' => '매직 링크: 비밀번호 공격 벡터 제거',
    'sbd_ml_desc' => '비밀번호가 없으면 훔치거나 유출하거나 무차별 대입할 대상이 없습니다. 이메일이 유일한 인증 수단입니다. 침해된 데이터베이스에서 자격 증명이 노출되지 않습니다 — 애초에 없기 때문입니다.',
    'sbd_fragment_title' => 'URL 프래그먼트: 키가 서버에 닿지 않음',
    'sbd_fragment_desc' => '복호화 키는 URL 프래그먼트(#)에 있습니다. HTTP 프로토콜 설계상 이 부분은 서버로 전송되지 않습니다 — 요청에도, 로그에도, 어디에도.',
    'sbd_destroy_title' => '자동 파괴: 노출 최소화',
    'sbd_destroy_desc' => '읽힌 비밀은 더 이상 존재하지 않습니다. 설정 가능한 만료와 일회용 옵션으로 노출 시간을 최소한으로 줄입니다.',
    ...
    'usecase1_title' => '비밀번호를 안전하게 공유하는 방법',
