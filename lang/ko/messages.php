...
return [
    ...
    'home_meta_description' => '비밀번호, API 키 또는 기밀 파일을 자동 삭제 링크로 공유하세요. 브라우저가 암호화하므로 서버는 내용을 볼 수 없습니다.',
    'home_answer_target' => 'Secret Drop은 비밀번호와 기밀 파일을 전송하기 전에 브라우저에서 암호화합니다. 서버는 읽을 수 없는 데이터만 저장하며 내용에 접근할 방법이 없습니다. 각 비밀은 만료되거나 조회 제한에 도달하면 자동 삭제됩니다. 무료, 계정 불필요, 추적 없음.',
    ...
    'how_it_works_intro' => '이메일이나 Slack으로 보낸 비밀번호는 거쳐 간 각 서비스의 메일함, 백업, 채팅 기록에 읽을 수 있는 상태로 남습니다. Secret Drop은 기밀 데이터를 전송하기 전에 브라우저에서 암호화하므로, 서버는 읽을 수 없는 데이터만 받습니다.',
    ...
    'how_step2_desc' => '브라우저가 임의의 키를 생성하고 <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>를 통해 <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a>으로 콘텐츠를 로컬에서 암호화합니다.',
    'how_step3_title' => '서버가 암호문을 저장',
    'how_step3_desc' => '서버는 암호화된 데이터를 키 없이 저장하므로 이를 복호화할 방법이 없습니다.',
    'how_step4_title' => '키는 URL에 유지',
    'how_step4_desc' => '브라우저는 복호화 키를 URL 프래그먼트(# 이후)에 넣습니다. 브라우저는 이 부분을 서버로 전송하지 않습니다.',
    'how_step5_title' => '수신자가 복호화',
    'how_step5_desc' => '수신자가 링크를 열면 브라우저가 암호화된 데이터를 가져오고 URL의 키를 사용하여 로컬에서 복호화합니다.',
    'how_step6_title' => '비밀이 파괴됨',
    'how_step6_desc' => '비밀이 조회 제한이나 만료 시간에 도달하면 서버는 암호화된 콘텐츠를 영구적으로 삭제합니다. 존재의 흔적만 남고 복호화할 것은 남지 않습니다.',
    'how_security_title' => '제로 지식 암호화란 무엇인가요?',
    'how_feature1_title' => '제로 지식',
    'how_feature1_desc' => '서버는 비밀을 읽을 방법이 없습니다. 법원이 데이터 제출을 명령하더라도 저희가 제공할 수 있는 것은 저희도 복호화할 수 없는 암호화된 콘텐츠뿐입니다.',
    'how_feature2_title' => '군사급 암호화',
    'how_feature2_desc' => 'AES-256-GCM은 NIST가 표준화한 방식이며, NSA는 최고 기밀(Top Secret) 등급까지의 정보 보호에 AES-256을 승인했습니다.',
    'how_feature3_title' => '계정 불필요',
    'how_feature3_desc' => '등록 없음, 추적 없음. 관리용으로 이메일을 입력하지 않는 한 비밀은 귀하와 연결되지 않습니다.',
    'how_feature4_title' => '자동 파기',
    'how_feature4_desc' => '각 비밀은 선택한 기간이 지나면 만료되며, 단일 읽기로 제한할 수도 있습니다. 이후 서버가 콘텐츠를 영구적으로 삭제합니다.',
    'how_cta' => '안전한 비밀 만들기',
    ...
    'faq_a1' => '네. 계정 없음, 구독 없음, 숨겨진 비용 없음.',
    'faq_q2' => '계정이 필요한가요?',
    'faq_a2' => '아니요. 가입 없음, 추적 없음. 관리용으로 이메일을 입력하지 않는 한 비밀은 당신과 연결되지 않습니다.',
    'faq_q3' => '비밀번호를 안전하게 공유하려면?',
    'faq_a3' => '비밀번호를 붙여넣고 만료 시간을 선택한 뒤, 원하면 1회 열람으로 제한하세요. Secret Drop이 브라우저에서 암호화하고 공유할 보안 링크를 제공합니다.',
    'faq_q4' => '최대 파일 크기는?',
    'faq_a4' => '파일은 최대 10MB, 메시지는 최대 50,000자입니다. 브라우저가 업로드 전에 파일을 암호화합니다.',
    'faq_q5' => '데이터는 어떻게 암호화되나요?',
    'faq_a5' => '브라우저가 무작위 키를 생성하고, W3C의 <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>를 통해 NIST가 권장하는 알고리즘인 <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a>으로 콘텐츠를 로컬에서 암호화합니다. 서버는 암호화된 데이터만 받으며 평문을 보지 못합니다.',
    'faq_q6' => '서버가 비밀을 읽을 수 있나요?',
    'faq_a6' => '아니요. 복호화 키는 URL 프래그먼트(# 뒤)에 머물며, 브라우저는 프래그먼트를 서버로 전송하지 않습니다. 키가 없으면 서버는 비밀을 복호화할 방법이 없습니다.',
    'faq_q7' => '열람 후에는 어떻게 되나요?',
    'faq_a7' => '비밀이 조회 제한에 도달하면 서버는 암호화된 콘텐츠를 영구 삭제하고 존재의 흔적만 남깁니다. 이후 누군가 링크를 가로채더라도 복호화할 것이 없습니다. 조회 제한을 설정하지 않으면 비밀은 만료될 때까지 열람할 수 있습니다.',
    'faq_q8' => '데이터는 어디에 저장되나요?',
    'faq_a8' => '프랑스에 위치한 서버에 저장됩니다. 서버는 암호화된 데이터만 저장하며 평문에는 접근할 수 없습니다.',
    'faq_q9' => 'Secret Drop은 GDPR을 준수하나요?',
    'faq_a9' => '네, 설계 단계부터 준수합니다. 제로 지식 암호화, 추적 없음, 광고 쿠키 없음, 만료 데이터 자동 삭제. Secret Drop은 개인 데이터를 평문으로 저장하지 않습니다.',
    ...
    'secure_by_design_intro' => '아래의 각 아키텍처 선택은 공격자가 접근할 수 있는 범위와 저희 스스로 접근할 수 있는 범위를 제한합니다.',
    'sbd_zk_title' => '제로 지식',
    'sbd_zk_desc' => '서버는 암호화 키를 받지 않으며, 이는 <a href="https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">OWASP 암호화 저장소</a> 원칙을 따릅니다. 데이터베이스를 탈취한 공격자는 복호화할 수 없는 암호화된 데이터만 얻게 됩니다.',
    'sbd_ml_title' => '비밀번호 없는 인증',
    'sbd_ml_desc' => '일회용 매직 링크가 비밀번호를 대체합니다. 데이터베이스에 자격 증명이 저장되지 않으므로, 데이터베이스를 탈취한 공격자가 해독할 대상이 없습니다.',
    'sbd_fragment_title' => '키는 기기를 떠나지 않습니다',
    'sbd_fragment_desc' => '복호화 키는 URL 프래그먼트(# 뒤)에 있습니다. 브라우저는 프래그먼트를 서버로 전송하지 않으므로 키는 요청에도 서버 로그에도 나타나지 않습니다.',
    'sbd_destroy_title' => '영구 파괴',
    'sbd_destroy_desc' => '비밀이 조회 제한에 도달하거나 만료되면 서버는 암호화된 콘텐츠를 삭제하고 존재의 흔적만 남깁니다. 만료 기간을 짧게 하고 조회 제한을 설정하면 비밀이 노출되는 시간이 줄어듭니다.',
    'sbd_hosted_title' => '프랑스 호스팅',
    'sbd_hosted_desc' => '저희 서버는 프랑스에 있으며 유럽연합 관할권에 속합니다. 데이터는 GDPR의 적용을 받고 EU 안에 머물며, 제3국으로 이전되지 않습니다.',
    'sbd_notrack_title' => '추적 없음',
    'sbd_notrack_desc' => '서드파티 쿠키, 추적 픽셀, 외부 서비스를 사용하지 않습니다. 저희는 제3자와 데이터를 공유하지 않으며, 이 사이트에서의 활동을 프로파일링하거나 판매하지 않습니다.',
    ...
    'use_cases_meta_description' => '비밀번호, 민감한 문서, API 키 등 기밀 데이터를 암호화된 자동 삭제 링크로 공유하는 방법.',
    'use_cases_intro' => '많은 팀이 매일 비밀번호, 계약서, API 키를 이메일, Slack, SMS로 평문 전송합니다. Secret Drop을 사용하면 종단간 암호화된 링크로 보낼 수 있습니다.',
    'usecase1_title' => '비밀번호와 자격 증명',
    'usecase1_desc' => '새 팀원에게 액세스가 필요합니다. 양쪽 메일함에 읽을 수 있는 상태로 남는 이메일 대신, 열람 후 자동 삭제되는 링크를 보내세요.',
    'usecase1_example' => 'CMS 액세스, 공유 계정, 계약자용 Wi-Fi 자격 증명.',
    'usecase1_tip' => '만료 1시간, 1회 읽기로 설정하세요. 수신자가 제시간에 링크를 열지 않으면 비밀번호를 변경하세요.',
    'usecase2_title' => '기밀 문서',
    'usecase2_desc' => '계약서, 신분증, 급여 명세서 등 받은 편지함이나 제3자 서버에 남아서는 안 되는 파일.',
    'usecase2_example' => '은행용 신분증, 서명된 계약서, 급여 명세서.',
    'usecase2_tip' => '만료 24시간, 1회 읽기, 민감한 문서에는 암호문 권장.',
    'usecase3_title' => 'API 키와 토큰',
    'usecase3_desc' => 'Slack 채널에 붙여넣은 API 키는 채널의 모든 사람이 평문으로 읽을 수 있는 상태로 남습니다. 일회용 링크는 수신자가 여는 순간 더 이상 작동하지 않습니다.',
    'usecase3_example' => 'Stripe 키, GitHub 토큰, 환경 변수.',
    'usecase3_tip' => '만료 1시간, 1회 읽기, 분할 모드 권장: 링크는 이메일로, 키는 메신저로.',
    'usecase4_title' => 'SSH 키와 인증서',
    'usecase4_desc' => '서버 액세스 부여가 이메일에 개인 키를 복사 붙여넣기하는 것이어서는 안 됩니다.',
    'usecase4_example' => '임시 서버 액세스, 서명 인증서, 배포 키.',
    'usecase4_tip' => '만료 1시간, 1회 읽기, 분할 모드. 사용 후 서버에서 SSH 키를 폐기하세요.',
    'usecase5_title' => 'Wi-Fi 비밀번호',
    'usecase5_desc' => '메모지에 적지 않고 Wi-Fi 비밀번호를 공유하세요. 손님은 내장 QR 코드를 스캔해 휴대폰에서 링크를 열 수 있습니다.',
    'usecase5_example' => '사무실 방문객, Airbnb 게스트, 회의실.',
    'usecase5_tip' => '만료 7일, 여러 번 읽기 허용. QR 코드로 즉시 모바일 공유.',
    'usecase6_title' => '개인 정보',
    'usecase6_desc' => '카드 번호, PIN, 의료 정보 등 채팅 기록에 남아서는 안 되는 데이터.',
    'usecase6_example' => '구매용 카드 번호, 비상 액세스 코드.',
    'usecase6_tip' => '만료 1시간, 1회 읽기, 암호문. 다른 채널로 수신자에게 알려주세요.',
    'use_cases_tips_title' => '모범 사례',
    'use_cases_tip1' => '매우 민감한 정보에는 짧은 만료 시간(1시간 또는 1일)을 사용하세요.',
    'use_cases_tip2' => '수신자가 비밀을 한 번만 읽을 수 있도록 읽기 제한을 1로 설정하세요.',
    'use_cases_tip3' => '최대 보안을 위해 분리 모드를 사용하고 다른 채널로 키를 전송하세요.',
    'use_cases_cta' => '내 교류 보안하기',
    ...
    'legal_about_text' => 'Secret Drop은 이메일이나 메신저로 비밀번호와 민감한 파일을 보내는 대신 사용할 수 있는 무료 오픈 소스 대안으로, 개인정보를 존중하도록 설계되었습니다. 누구나 소스 코드를 읽고 감사할 수 있습니다.',
    'legal_about_security' => '제로 지식 아키텍처 덕분에 서버는 비밀의 내용에 접근할 방법이 없습니다. 브라우저가 AES-256-GCM 암호화를 수행하며, 복호화 키를 서버로 전송하지 않습니다.',
    ...
    'legal_cookies_text' => '이 웹사이트는 필수 기술 쿠키(세션, 테마 설정)만 사용합니다. 추적이나 광고 쿠키는 사용하지 않습니다.',
    ...
    'hint_p95_by_group' => "라우트 유형별 P95:\ncreate = 비밀 생성\nread = 조회 / 다운로드\nadmin = 관리 영역\nsuperadmin = 대시보드\npages = 홈페이지, FAQ, 법적 고지…",
    'stat_avg_secret_size' => '평균 비밀 크기',
    'hint_avg_secret_size' => '저장된 암호문의 평균 크기. 텍스트: 데이터베이스 내 암호문 크기. 파일: 디스크에 저장된 암호화 파일의 평균 크기.',
    'stat_page_home' => '홈',
    ...
    'stat_page_admin_poll' => '관리자 - 새로고침',
    'stat_page_admin_extend' => '관리자 - 연장',
    'stat_page_admin_revoke' => '관리자 - 취소',
    'stat_page_admin_logout' => '관리자 - 로그아웃',
    'stat_page_superadmin_request_access' => '슈퍼 관리자 - 접근 요청',
    'stat_page_superadmin_poll' => '슈퍼 관리자 - 새로고침',
    'stat_page_superadmin_logout' => '슈퍼 관리자 - 로그아웃',
    ...
    'hint_conversion' => '표시된 기간 동안 비밀을 생성한 인간 방문자의 비율. 전환율 = 생성된 비밀 ÷ 인간 방문자.',
