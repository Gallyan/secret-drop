...
return [
    ...
    'faq_a5' => 'ブラウザがランダムな鍵を生成し、コンテンツをローカルで暗号化します（Web Crypto API経由のAES-256-GCM）。サーバーは暗号化されたデータのみを受け取り、平文を見ることはありません。',
    ...
    'sbd_zk_title' => 'ゼロナレッジ',
    'sbd_zk_desc' => 'サーバーは暗号化キーを受け取りません。データベースが侵害されても、攻撃者が得るのは無意味なノイズだけです。これは約束ではなく、数学的な不可能性です。',
