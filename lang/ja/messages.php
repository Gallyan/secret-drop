...
return [
    ...
    // Features
    'feature_encryption' => 'ブラウザでAES-256-GCM暗号化',
    ...
    'crypto_passphrase_incorrect' => 'パスフレーズが間違っているか、データが破損しています',
    ...
    'legal_data_not_item_key' => '暗号化キー（URLフラグメントでのみ送信）',
    ...
    'admin_mode' => 'モード',
    'admin_single_use' => '単回使用',
    'admin_multi_use' => '複数回使用',
    'admin_day' => '日',
    'admin_days' => '日',
    'admin_extend' => '延長',
    'admin_revoke' => '取り消し',
