...
return [
    ...
    'faq_a10' => 'はい、Secret Dropのソースコードはビジネスソースライセンス（BSL）で公開されています。暗号化ロジックを検査し、バックドアがないことを確認し、ゼロナレッジアーキテクチャが説明どおりに機能していることを確かめることができます。',
