...
return [
    ...
    'max_security' => 'Sécurité max',
    'max_security_tooltip' => 'Configure toutes les options en un clic pour le niveau de sécurité maximum.',
    ...
    'how_it_works_intro' => 'Secret Drop utilise un chiffrement de bout en bout (E2E) pour garantir que seul le destinataire puisse lire vos secrets. Le serveur ne stocke que des données chiffrées et n\'a jamais accès au contenu en clair.',
    'how_it_works_diagram_title' => 'Le processus de chiffrement',
    ...
    'faq_a6' => 'Vous pouvez partager des fichiers jusqu\'à 10 Mo et des messages texte jusqu\'à 50 000 caractères. Les fichiers sont chiffrés dans votre navigateur avant l\'envoi.',
    'faq_q7' => 'Où sont stockées les données ?',
    'faq_a7' => 'Toutes les données sont stockées sur des serveurs situés en France. Seules les données chiffrées sont conservées — le serveur n\'a jamais accès au contenu en clair de vos secrets.',
    'faq_q8' => 'Secret Drop est-il conforme au RGPD ?',
    'faq_a8' => 'Oui, par conception. Secret Drop utilise le chiffrement zero-knowledge, ne piste pas les utilisateurs, n\'utilise pas de cookies publicitaires et supprime automatiquement les données expirées. Aucune donnée personnelle n\'est stockée en clair.',
    ...
    'use_cases_intro' => 'Secret Drop est l\'outil idéal pour partager des informations sensibles de manière sécurisée. Voici quelques exemples concrets.',
    'usecase1_title' => 'Partager un mot de passe en sécurité',
    'usecase1_desc' => 'Partagez en toute sécurité des identifiants avec vos collègues, clients ou prestataires sans passer par des canaux non sécurisés comme l\'email ou les messageries.',
    'usecase1_example' => 'Exemple : Transmettre les accès à un nouveau collaborateur, partager un mot de passe Wi-Fi avec un invité.',
    'usecase2_title' => 'Documents confidentiels',
    'usecase2_desc' => 'Envoyez des documents sensibles (contrats, factures, documents d\'identité) sans craindre qu\'ils soient interceptés ou stockés sur des serveurs tiers.',
    'usecase2_example' => 'Exemple : Envoyer une pièce d\'identité à une banque, transmettre un contrat signé.',
    'usecase3_title' => 'Clés API et tokens',
    'usecase3_desc' => 'Les développeurs peuvent partager des clés d\'API, tokens d\'authentification ou secrets d\'application de manière sécurisée.',
    'usecase3_example' => 'Exemple : Partager une clé Stripe avec un prestataire, transmettre des variables d\'environnement.',
    'usecase4_title' => 'Clés SSH et certificats',
    'usecase4_desc' => 'Transmettez des clés SSH privées ou des certificats SSL à vos administrateurs système en toute sécurité.',
    'usecase4_example' => 'Exemple : Donner un accès serveur temporaire, partager un certificat de signature.',
    'usecase5_title' => 'Mots de passe Wi-Fi',
    'usecase5_desc' => 'Partagez facilement le mot de passe de votre réseau avec vos invités via un QR code sécurisé.',
    'usecase5_example' => 'Exemple : Accueillir des visiteurs au bureau, partager l\'accès à un Airbnb.',
    'usecase6_title' => 'Informations personnelles',
    'usecase6_desc' => 'Transmettez des données personnelles sensibles (numéros de compte, codes PIN) à des proches de confiance.',
    'usecase6_example' => 'Exemple : Partager un numéro de carte bancaire pour un achat, transmettre des codes d\'accès en cas d\'urgence.',
    'use_cases_tips_title' => 'Bonnes pratiques',
    'use_cases_tip1' => 'Utilisez une expiration courte (1 heure ou 1 jour) pour les informations très sensibles.',
    'use_cases_tip2' => 'Activez la limite de lecture à 1 pour garantir que le secret ne peut être lu qu\'une fois.',
    'use_cases_tip3' => 'Pour une sécurité maximale, utilisez le mode séparé et transmettez la clé par un autre canal.',
    'use_cases_cta' => 'Créer un secret maintenant',
    ...
    'stat_system_health' => 'Santé système',
