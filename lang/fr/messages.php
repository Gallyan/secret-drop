...
return [
    ...
    'home_meta_description' => 'Partagez mot de passe, clé API ou fichier confidentiel via un lien qui s\'autodétruit. Votre navigateur le chiffre : le serveur ne voit jamais le contenu.',
    'home_answer_target' => 'Secret Drop chiffre vos mots de passe et fichiers confidentiels dans votre navigateur avant de les envoyer. Le serveur ne stocke que des données illisibles et n\'a aucun moyen d\'accéder au contenu. Chaque secret s\'autodétruit à son expiration ou quand il atteint sa limite de lectures. Gratuit, sans compte, sans traceur.',
    ...
    'text_too_large' => 'Le texte est trop long (max 50 000 caractères)',
    ...
    'how_it_works_intro' => 'Un mot de passe envoyé par email ou Slack reste lisible dans les boîtes mail, les sauvegardes et les historiques de chaque service qu\'il traverse. Secret Drop chiffre vos données confidentielles dans votre navigateur avant l\'envoi : le serveur ne reçoit que des données qu\'il ne peut pas lire.',
    ...
    'how_step2_desc' => 'Votre navigateur génère une clé aléatoire et chiffre le contenu localement avec <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a> via la <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>.',
    'how_step3_title' => 'Le serveur stocke le contenu chiffré',
    'how_step3_desc' => 'Le serveur enregistre les données chiffrées sans la clé : il n\'a aucun moyen de les déchiffrer.',
    'how_step4_title' => 'La clé reste dans l\'URL',
    'how_step4_desc' => 'Votre navigateur place la clé de déchiffrement dans le fragment de l\'URL (après le #). Les navigateurs n\'envoient jamais cette partie au serveur.',
    ...
    'how_step6_desc' => 'Dès que le secret atteint sa limite de lectures ou sa date d\'expiration, le serveur supprime définitivement le contenu chiffré. Il ne garde qu\'une trace de son existence, sans rien à déchiffrer.',
    'how_security_title' => 'Qu\'est-ce que le chiffrement zero-knowledge ?',
    'how_feature1_title' => 'Zero-knowledge',
    'how_feature1_desc' => 'Le serveur n\'a aucun moyen de lire vos secrets. Si un tribunal nous demande des données, nous ne pouvons fournir que du contenu chiffré que nous ne savons pas déchiffrer.',
    'how_feature2_title' => 'Chiffrement militaire',
    'how_feature2_desc' => 'Le NIST a normalisé AES-256-GCM, et la NSA approuve AES-256 pour protéger des informations classifiées jusqu\'au niveau Top Secret.',
    'how_feature3_title' => 'Pas de compte requis',
    'how_feature3_desc' => 'Aucune inscription, aucun tracking. Sauf si vous indiquez un email pour les gérer, rien ne relie vos secrets à vous.',
    'how_feature4_title' => 'Auto-destruction',
    'how_feature4_desc' => 'Chaque secret expire après la durée que vous choisissez, et vous pouvez le limiter à une seule lecture. Le serveur supprime ensuite le contenu définitivement.',
    ...
    'faq_a1' => 'Oui. Pas de compte, pas d\'abonnement, pas de frais cachés.',
    'faq_q2' => 'Ai-je besoin d\'un compte ?',
    'faq_a2' => 'Non. Pas d\'inscription, pas de suivi. Sauf si vous indiquez un email pour les gérer, rien ne relie vos secrets à vous.',
    'faq_q3' => 'Comment partager un mot de passe en toute sécurité ?',
    'faq_a3' => 'Collez votre mot de passe, choisissez une durée d\'expiration et, si vous le souhaitez, limitez-le à une seule lecture. Secret Drop le chiffre dans votre navigateur et vous donne un lien sécurisé à partager.',
    'faq_q4' => 'Quelle est la taille maximale des fichiers ?',
    'faq_a4' => 'Jusqu\'à 10 Mo pour les fichiers et 50 000 caractères pour les messages. Votre navigateur chiffre les fichiers avant l\'envoi.',

    // Sécurité
    'faq_q5' => 'Comment mes données sont-elles chiffrées ?',
    'faq_a5' => 'Votre navigateur génère une clé aléatoire et chiffre le contenu localement avec <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a>, l\'algorithme recommandé par le NIST, via la <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a> du W3C. Le serveur ne reçoit que des données chiffrées et ne voit jamais le contenu en clair.',
    'faq_q6' => 'Le serveur peut-il lire mes secrets ?',
    'faq_a6' => 'Non. La clé de déchiffrement reste dans le fragment de l\'URL (après le #), et les navigateurs n\'envoient jamais ce fragment au serveur. Sans la clé, le serveur n\'a aucun moyen de déchiffrer vos secrets.',
    'faq_q7' => 'Que se passe-t-il après la lecture ?',
    'faq_a7' => 'Dès que le secret atteint sa limite de lectures, le serveur supprime définitivement le contenu chiffré et ne garde qu\'une trace de son existence. Si quelqu\'un intercepte le lien après coup, il ne trouve rien à déchiffrer. Sans limite de lectures, le secret reste disponible jusqu\'à son expiration.',

    // Confiance
    'faq_q8' => 'Où sont stockées les données ?',
    'faq_a8' => 'Sur des serveurs situés en France. Le serveur ne stocke que des données chiffrées et n\'a jamais accès au contenu en clair.',
    'faq_q9' => 'Secret Drop est-il conforme au RGPD ?',
    'faq_a9' => 'Oui, par conception. Chiffrement zero-knowledge, aucun tracking, aucun cookie publicitaire, suppression automatique des données expirées. Secret Drop ne stocke aucune donnée personnelle en clair.',
    ...
    'faq_a11' => 'L\'email chiffré (PGP, S/MIME) exige que les deux parties configurent des clés au préalable. Avec Secret Drop, votre destinataire n\'a besoin que du lien. Le secret s\'autodétruit ensuite, alors qu\'un email reste dans les deux boîtes.',
    'faq_q12' => 'Comment gérer mes secrets après leur création ?',
    'faq_a12' => 'Si vous avez fourni votre email, vous pouvez révoquer ou prolonger vos secrets via le lien :manage_link en bas de chaque page. Vous recevrez un magic link à usage unique, valable :minutes minutes. Sans mot de passe, il n\'y a rien à voler.',
    ...
    'secure_by_design_intro' => 'Chacun des choix d\'architecture ci-dessous limite ce à quoi un attaquant pourrait accéder, et ce à quoi nous-mêmes avons accès.',
    'sbd_zk_title' => 'Zero-knowledge',
    'sbd_zk_desc' => 'Le serveur ne reçoit jamais la clé de chiffrement, conformément aux principes de <a href="https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">stockage cryptographique OWASP</a>. Un attaquant qui vole la base de données n\'obtient que des données chiffrées qu\'il ne peut pas déchiffrer.',
    'sbd_ml_title' => 'Authentification sans mot de passe',
    'sbd_ml_desc' => 'Un magic link à usage unique remplace le mot de passe. La base de données ne stocke aucun identifiant : un attaquant qui la vole n\'a rien à casser.',
    'sbd_fragment_title' => 'La clé ne transite pas',
    'sbd_fragment_desc' => 'La clé de déchiffrement se trouve dans le fragment de l\'URL (après le #). Les navigateurs n\'envoient jamais ce fragment au serveur : la clé n\'apparaît ni dans les requêtes ni dans les logs du serveur.',
    'sbd_destroy_title' => 'Destruction définitive',
    'sbd_destroy_desc' => 'Dès qu\'un secret atteint sa limite de lectures ou expire, le serveur supprime le contenu chiffré et ne garde qu\'une trace de son existence. Une expiration courte et une limite de lectures réduisent la durée pendant laquelle votre secret reste exposé.',
    'sbd_hosted_title' => 'Hébergé en France',
    'sbd_hosted_desc' => 'Nos serveurs sont en France, sous la juridiction de l\'Union européenne. Vos données relèvent du RGPD et restent dans l\'UE, sans transfert vers des pays tiers.',
    'sbd_notrack_title' => 'Aucun traceur',
    'sbd_notrack_desc' => 'Aucun cookie tiers, pixel de suivi ou service externe. Nous ne partageons aucune donnée avec des tiers, et nous ne profilons ni ne revendons votre activité sur ce site.',
    ...
    'use_cases_meta_description' => 'Comment partager mots de passe, documents sensibles, clés API et autres données confidentielles via un lien chiffré qui s\'autodétruit.',
    'use_cases_intro' => 'Chaque jour, des équipes envoient en clair mots de passe, contrats et clés API par email, Slack ou SMS. Avec Secret Drop, vous les envoyez plutôt via un lien chiffré de bout en bout.',
    'usecase1_title' => 'Mots de passe et identifiants',
    'usecase1_desc' => 'Un nouveau collaborateur a besoin des accès. Au lieu d\'un email qui reste lisible dans les deux boîtes, envoyez un lien qui s\'autodétruit après lecture.',
    'usecase1_example' => 'Accès CMS, comptes partagés, identifiants Wi-Fi pour un prestataire.',
    'usecase1_tip' => 'Expiration 1h, lecture unique. Changez le mot de passe si votre destinataire n\'ouvre pas le lien à temps.',
    ...
    'usecase3_desc' => 'Une clé API collée dans un canal Slack reste lisible en clair par tous ses membres. Un lien à usage unique cesse de fonctionner dès que votre destinataire l\'ouvre.',
    ...
    'usecase5_desc' => 'Partagez le mot de passe Wi-Fi sans l\'écrire sur un post-it. Vos invités scannent le QR code intégré pour ouvrir le lien sur leur téléphone.',
    ...
    'usecase6_desc' => 'Numéro de carte, code PIN, informations médicales : des données qui ne devraient pas rester dans un historique de conversation.',
    ...
    'use_cases_tip2' => 'Limite de lecture à 1 : votre destinataire ne peut lire le secret qu\'une seule fois.',
    ...
    'legal_about_text' => 'Secret Drop est une alternative open source et gratuite à l\'envoi de mots de passe et de fichiers sensibles par email ou messagerie, pensée pour respecter votre vie privée. Chacun peut lire et auditer le code source.',
    'legal_about_security' => 'Grâce à l\'architecture zero-knowledge, le serveur n\'a aucun moyen d\'accéder au contenu de vos secrets. Votre navigateur effectue le chiffrement AES-256-GCM et ne transmet jamais la clé de déchiffrement au serveur.',
    ...
    'legal_data_text' => 'Secret Drop suit le principe « zero-knowledge ». Votre navigateur chiffre les secrets avant de les envoyer au serveur, qui ne stocke que des données chiffrées et ne peut pas accéder à leur contenu en clair.',
    ...
    'legal_cookies_text' => 'Ce site utilise uniquement des cookies techniques essentiels au fonctionnement (session, préférence de thème). Il n\'utilise aucun cookie de tracking ou publicitaire.',
    ...
    'admin_no_expiry' => 'Sans expiration',
    ...
    'email_storage_quota_subject' => '[:level] Stockage à :percent% - :app',
    ...
    'email_storage_quota_consequence' => 'Une fois le quota atteint, les nouveaux secrets sont refusés avec une erreur HTTP 503 jusqu\'à ce que de l\'espace soit libéré.',
    'email_storage_quota_action' => 'Libérez de l\'espace en supprimant les secrets expirés, ou augmentez le quota de stockage configuré.',
    ...
    'stat_page_admin_poll' => 'Admin - Actualisation',
    'stat_page_admin_extend' => 'Admin - Prolongation',
    'stat_page_admin_revoke' => 'Admin - Révocation',
    'stat_page_admin_logout' => 'Admin - Déconnexion',
    'stat_page_superadmin_request_access' => 'Super Admin - Demande d\'accès',
    'stat_page_superadmin_poll' => 'Super Admin - Actualisation',
    'stat_page_superadmin_logout' => 'Super Admin - Déconnexion',
    ...
    'val_hours_required' => 'Le nombre d\'heures est requis.',
    'val_hours_integer' => 'Le nombre d\'heures doit être un entier.',
    'val_hours_min' => 'Le nombre d\'heures doit être au moins 1.',
    'val_hours_max' => 'Le nombre d\'heures ne peut pas dépasser 720.',
    ...
    'hint_errors_5xx' => 'Total des erreurs serveur (500-599). Toute valeur supérieure à 0 signifie un bug ou un problème d\'infrastructure : consultez les logs sans attendre.',
