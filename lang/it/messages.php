...
return [
    ...
    'how_step2_desc' => 'Il tuo browser genera una chiave casuale e crittografa il contenuto localmente con <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a> tramite la <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>. Il server riceve solo dati crittografati.',
    ...
    'faq_a5' => 'Il browser genera una chiave casuale e crittografa il contenuto localmente con <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a>, l\'algoritmo raccomandato dal NIST, tramite la <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a> del W3C. Il server riceve solo dati crittografati — non vede mai il contenuto in chiaro.',
    ...
    'faq_a12' => 'Se hai fornito la tua email, puoi revocare o estendere i tuoi segreti tramite il link :manage_link in fondo a ogni pagina. Riceverai un link monouso valido :minutes minuti — un magic link, senza password. Niente da rubare, niente da violare.',
    ...
    'sbd_zk_desc' => 'Il server non riceve mai la chiave di crittografia — secondo i principi di <a href="https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">archiviazione crittografica OWASP</a>. Anche se il database viene compromesso, un attaccante ottiene solo rumore inutile. Non è una promessa — è un\'impossibilità matematica.',
    ...
    'usecase1_tip' => 'Scadenza 1 ora, lettura singola. Cambia la password se il link non è stato aperto in tempo.',
