...
return [
    ...
    'max_security' => 'Sicurezza max',
    'max_security_tooltip' => 'Configura tutte le opzioni in un clic per il massimo livello di sicurezza.',
    ...
    'how_it_works_intro' => 'Secret Drop utilizza la crittografia end-to-end (E2E) per garantire che solo il destinatario possa leggere i tuoi segreti. Il server memorizza solo dati crittografati e non ha mai accesso al contenuto in chiaro.',
    'how_it_works_diagram_title' => 'Il processo di crittografia',
    ...
    'faq_a2' => 'No. Secret Drop utilizza un\'architettura zero-knowledge. La chiave di decrittazione è nel frammento dell\'URL (dopo #), che non viene mai inviato al server.',
    ...
    'faq_a6' => 'Puoi condividere file fino a 10 MB e messaggi di testo fino a 50.000 caratteri. I file vengono crittografati nel browser prima del caricamento.',
    'faq_q7' => 'Dove vengono archiviati i dati?',
    'faq_a7' => 'Tutti i dati sono archiviati su server situati in Francia. Vengono conservati solo dati crittografati — il server non ha mai accesso al contenuto in chiaro dei tuoi segreti.',
    'faq_q8' => 'Secret Drop è conforme al GDPR?',
    'faq_a8' => 'Sì, per progettazione. Secret Drop utilizza la crittografia zero-knowledge, non traccia gli utenti, non usa cookie pubblicitari e cancella automaticamente i dati scaduti. Nessun dato personale viene archiviato in chiaro.',
    'faq_q9' => 'Come condividere una password in modo sicuro?',
    'faq_a9' => 'Incolla la password, scegli un tempo di scadenza e opzionalmente limita a una singola lettura. Secret Drop la cripta nel browser e ti fornisce un link sicuro da condividere. La password non è mai visibile al server.',
    'faq_q10' => 'Secret Drop è open source?',
    'faq_a10' => 'Sì, il codice sorgente di Secret Drop è disponibile pubblicamente sotto licenza Business Source License (BSL). Puoi ispezionare la logica di crittografia, verificare l\'assenza di backdoor e confermare che l\'architettura zero-knowledge funziona come descritto.',
    ...
    'use_cases_intro' => 'Secret Drop è lo strumento ideale per condividere informazioni sensibili in modo sicuro. Ecco alcuni esempi concreti.',
    'usecase1_title' => 'Condividere una password in modo sicuro',
    'usecase1_desc' => 'Condividi credenziali in sicurezza con colleghi, clienti o collaboratori senza usare canali insicuri come email o messaggistica.',
    'usecase1_example' => 'Esempio: Inviare credenziali a un nuovo membro del team, condividere password Wi-Fi con un ospite.',
    'usecase2_title' => 'Documenti riservati',
    'usecase2_desc' => 'Invia documenti sensibili (contratti, fatture, documenti d\'identità) senza preoccuparti di intercettazioni o archiviazione su server di terze parti.',
    'usecase2_example' => 'Esempio: Inviare documento d\'identità a una banca, trasmettere un contratto firmato.',
    'usecase3_title' => 'Chiavi API e token',
    'usecase3_desc' => 'Gli sviluppatori possono condividere chiavi API, token di autenticazione o segreti applicativi in modo sicuro.',
    'usecase3_example' => 'Esempio: Condividere una chiave Stripe con un fornitore, trasmettere variabili d\'ambiente.',
    'usecase4_title' => 'Chiavi SSH e certificati',
    'usecase4_desc' => 'Trasmetti chiavi SSH private o certificati SSL ai tuoi amministratori di sistema in modo sicuro.',
    'usecase4_example' => 'Esempio: Dare accesso temporaneo al server, condividere un certificato di firma.',
    'usecase5_title' => 'Password Wi-Fi',
    'usecase5_desc' => 'Condividi facilmente la password della tua rete con gli ospiti tramite un codice QR sicuro.',
    'usecase5_example' => 'Esempio: Accogliere visitatori in ufficio, condividere accesso a un Airbnb.',
    'usecase6_title' => 'Informazioni personali',
    'usecase6_desc' => 'Trasmetti dati personali sensibili (numeri di conto, codici PIN) a familiari di fiducia.',
    'usecase6_example' => 'Esempio: Condividere numero di carta di credito per un acquisto, trasmettere codici di accesso in caso di emergenza.',
    ...
    'use_cases_cta' => 'Crea un segreto ora',
