...
return [
    ...
    // Features
    'feature_encryption' => 'Crittografia AES-256-GCM nel tuo browser',
    ...
    'destroy_after_read' => 'Distruggi dopo la lettura',
    ...
    'warning_passphrase_required' => 'Il destinatario dovrà inserire la passphrase per decriptare il segreto.',
    ...
    'passphrase_protected' => 'Questo segreto è protetto da una passphrase.',
    'passphrase_input_placeholder' => 'Inserisci la passphrase',
    ...
    'crypto_passphrase_required' => 'Passphrase richiesta',
    'crypto_passphrase_incorrect' => 'Passphrase errata o dati corrotti',
    ...
    'legal_data_not_item_key' => 'Chiavi di crittografia (trasmesse solo tramite frammento URL)',
    ...
    'admin_mode' => 'Modalità',
    'admin_single_use' => 'Uso singolo',
    'admin_multi_use' => 'Uso multiplo',
    'admin_day' => 'giorno',
    'admin_days' => 'giorni',
    ...
    'stat_file' => 'File',
    'stat_reads' => 'Letture',
    'stat_passphrase' => 'Con passphrase',
    'stat_single_use' => 'Uso singolo',
