...
return [
    ...
    'faq_a5' => 'Uw browser genereert een willekeurige sleutel en versleutelt de inhoud lokaal (AES-256-GCM via Web Crypto API). De server ontvangt alleen versleutelde gegevens — hij ziet nooit de leesbare inhoud.',
    ...
    'sbd_zk_desc' => 'De server ontvangt nooit de encryptiesleutel. Zelfs bij een datalek krijgt een aanvaller alleen nutteloze ruis. Dit is geen belofte — het is een wiskundige onmogelijkheid.',
