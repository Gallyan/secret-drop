...
return [
    ...
    'home_meta_description' => 'Deel een wachtwoord, API-sleutel of vertrouwelijk bestand via een zelfvernietigende link. Uw browser versleutelt de inhoud, zodat de server die nooit ziet.',
    'home_answer_target' => 'Secret Drop versleutelt uw wachtwoorden en vertrouwelijke bestanden in uw browser en verstuurt ze pas daarna. De server slaat alleen onleesbare gegevens op en kan op geen enkele manier bij de inhoud. Elk geheim vernietigt zichzelf zodra het verloopt of zijn leeslimiet bereikt. Gratis, zonder account, zonder tracking.',
    ...
    'how_it_works_intro' => 'Een wachtwoord dat u via e-mail of Slack verstuurt, blijft leesbaar in de mailboxen, back-ups en chatgeschiedenis van elke dienst die het passeert. Secret Drop versleutelt uw vertrouwelijke gegevens in uw browser voordat het ze verstuurt, zodat de server alleen gegevens ontvangt die hij niet kan lezen.',
    ...
    'how_step2_desc' => 'Uw browser genereert een willekeurige sleutel en versleutelt de inhoud lokaal met <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a> via de <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>.',
    'how_step3_title' => 'Server slaat versleutelde gegevens op',
    'how_step3_desc' => 'De server slaat de versleutelde gegevens op zonder de sleutel en kan ze dus op geen enkele manier ontsleutelen.',
    'how_step4_title' => 'Sleutel blijft in de URL',
    'how_step4_desc' => 'Uw browser plaatst de ontsleutelingssleutel in het URL-fragment (na de #). Browsers sturen dit deel nooit naar de server.',
    ...
    'how_step6_desc' => 'Zodra het geheim zijn leeslimiet of vervaldatum bereikt, verwijdert de server de versleutelde inhoud permanent. Alleen een spoor van het bestaan blijft over, zonder iets om te ontsleutelen.',
    'how_security_title' => 'Wat is zero-knowledge-encryptie?',
    'how_feature1_title' => 'Zero-knowledge',
    'how_feature1_desc' => 'De server kan uw geheimen op geen enkele manier lezen. Als een rechter ons verplicht gegevens te overhandigen, kunnen we alleen versleutelde inhoud leveren die we zelf niet kunnen ontsleutelen.',
    'how_feature2_title' => 'Militaire encryptie',
    'how_feature2_desc' => 'NIST heeft AES-256-GCM gestandaardiseerd, en de NSA keurt AES-256 goed voor de beveiliging van gerubriceerde informatie tot en met het niveau Top Secret.',
    'how_feature3_title' => 'Geen account vereist',
    'how_feature3_desc' => 'Geen registratie, geen tracking. Tenzij u een e-mailadres opgeeft om ze te beheren, koppelt niets uw geheimen aan u.',
    'how_feature4_title' => 'Auto-destructie',
    'how_feature4_desc' => 'Elk geheim verloopt na de termijn die u kiest, en u kunt het beperken tot één lezing. Daarna verwijdert de server de inhoud permanent.',
    ...
    'faq_a1' => 'Ja. Geen account, geen abonnement, geen verborgen kosten.',
    'faq_q2' => 'Heb ik een account nodig?',
    'faq_a2' => 'Nee. Geen registratie, geen tracking. Tenzij u een e-mailadres opgeeft om ze te beheren, koppelt niets uw geheimen aan u.',
    'faq_q3' => 'Hoe deel ik veilig een wachtwoord?',
    'faq_a3' => 'Plak uw wachtwoord, kies een vervaltijd en beperk het desgewenst tot één lezing. Secret Drop versleutelt het in uw browser en geeft u een veilige link om te delen.',
    'faq_q4' => 'Wat is de maximale bestandsgrootte?',
    'faq_a4' => 'Tot 10 MB voor bestanden en 50.000 tekens voor berichten. Uw browser versleutelt bestanden vóór het uploaden.',
    'faq_q5' => 'Hoe worden mijn gegevens versleuteld?',
    'faq_a5' => 'Uw browser genereert een willekeurige sleutel en versleutelt de inhoud lokaal met <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a>, het door NIST aanbevolen algoritme, via de <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a> van het W3C. De server ontvangt alleen versleutelde gegevens en ziet nooit de leesbare inhoud.',
    'faq_q6' => 'Kan de server mijn geheimen lezen?',
    'faq_a6' => 'Nee. De decryptiesleutel blijft in het URL-fragment (na de #), en browsers sturen het fragment nooit naar de server. Zonder de sleutel kan de server uw geheimen op geen enkele manier ontsleutelen.',
    'faq_q7' => 'Wat gebeurt er na het lezen?',
    'faq_a7' => 'Zodra het geheim zijn leeslimiet bereikt, verwijdert de server de versleutelde inhoud permanent en bewaart hij alleen een spoor van het bestaan. Als iemand de link daarna onderschept, vindt hij niets om te ontsleutelen. Zonder leeslimiet blijft het geheim beschikbaar tot het verloopt.',
    ...
    'secure_by_design_intro' => 'Elke architectuurkeuze hieronder beperkt waar een aanvaller bij zou kunnen, en waar wijzelf bij kunnen.',
    'sbd_zk_title' => 'Zero-knowledge',
    'sbd_zk_desc' => 'De server ontvangt nooit de encryptiesleutel, in overeenstemming met de <a href="https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">OWASP-richtlijnen voor cryptografische opslag</a>. Een aanvaller die de database steelt, krijgt alleen versleutelde gegevens die hij niet kan ontsleutelen.',
    'sbd_ml_title' => 'Authenticatie zonder wachtwoord',
    'sbd_ml_desc' => 'Een eenmalige magic link vervangt het wachtwoord. De database bevat geen inloggegevens, dus een aanvaller die hem steelt, heeft niets om te kraken.',
    'sbd_fragment_title' => 'De sleutel verlaat uw apparaat nooit',
    'sbd_fragment_desc' => 'De decryptiesleutel staat in het URL-fragment (na de #). Browsers sturen het fragment nooit naar de server, dus de sleutel verschijnt niet in verzoeken en niet in de serverlogs.',
    'sbd_destroy_title' => 'Definitieve vernietiging',
    'sbd_destroy_desc' => 'Zodra een geheim zijn leeslimiet bereikt of verloopt, verwijdert de server de versleutelde inhoud en bewaart hij alleen een spoor van het bestaan. Een korte vervaltijd en een leeslimiet verkorten de tijd dat uw geheim blootgesteld is.',
    'sbd_hosted_title' => 'Gehost in Frankrijk',
    'sbd_hosted_desc' => 'Onze servers staan in Frankrijk, onder de jurisdictie van de Europese Unie. Uw gegevens vallen onder de AVG en blijven in de EU, zonder overdracht naar derde landen.',
    'sbd_notrack_title' => 'Geen tracking',
    'sbd_notrack_desc' => 'Geen cookies van derden, trackingpixels of externe diensten. We delen geen gegevens met derden, en we profileren of verkopen uw activiteit op deze site niet.',
    ...
    'use_cases_meta_description' => 'Zo deelt u wachtwoorden, gevoelige documenten, API-sleutels en andere vertrouwelijke gegevens via een versleutelde, zelfvernietigende link.',
    'use_cases_intro' => 'Teams versturen elke dag wachtwoorden, contracten en API-sleutels in platte tekst via e-mail, Slack of SMS. Met Secret Drop verstuurt u ze via een end-to-end versleutelde link.',
    'usecase1_title' => 'Wachtwoorden en inloggegevens',
    'usecase1_desc' => 'Een nieuw teamlid heeft toegang nodig. Stuur in plaats van een e-mail die in beide inboxen leesbaar blijft een link die zichzelf vernietigt na het lezen.',
    'usecase1_example' => 'CMS-toegang, gedeelde accounts, Wi-Fi-gegevens voor een leverancier.',
    'usecase1_tip' => 'Verloop 1 uur, eenmalig lezen. Wijzig het wachtwoord als uw ontvanger de link niet op tijd opent.',
    'usecase2_title' => 'Vertrouwelijke documenten',
    'usecase2_desc' => 'Contracten, identiteitsdocumenten, loonstroken: bestanden die niet in een inbox of op een server van derden horen te blijven.',
    ...
    'usecase3_desc' => 'Een API-sleutel die in een Slack-kanaal is geplakt, blijft in platte tekst leesbaar voor iedereen in dat kanaal. Een eenmalige link werkt niet meer zodra uw ontvanger hem opent.',
    ...
    'usecase5_desc' => 'Deel het Wi-Fi-wachtwoord zonder het op een briefje te schrijven. Uw gasten scannen de ingebouwde QR-code om de link op hun telefoon te openen.',
    ...
    'usecase6_desc' => 'Kaartnummers, pincodes, medische informatie: gegevens die niet in een chatgeschiedenis horen te blijven.',
    ...
    'use_cases_tip2' => 'Stel de leeslimiet in op 1, zodat uw ontvanger het geheim maar één keer kan lezen.',
    ...
    'legal_about_text' => 'Secret Drop is een gratis open-sourcealternatief voor het versturen van wachtwoorden en gevoelige bestanden via e-mail of berichten-apps, ontworpen met respect voor uw privacy. Iedereen kan de broncode lezen en controleren.',
    'legal_about_security' => 'Dankzij de zero-knowledge-architectuur kan de server op geen enkele manier bij de inhoud van uw geheimen. Uw browser voert de AES-256-GCM-versleuteling uit en stuurt de ontsleutelingssleutel nooit naar de server.',
    ...
    'legal_cookies_text' => 'Deze website gebruikt alleen essentiële technische cookies (sessie, themavoorkeur) en geen tracking- of advertentiecookies.',
    ...
    'stat_page_admin_poll' => 'Admin - Vernieuwing',
    'stat_page_admin_extend' => 'Admin - Verlenging',
    'stat_page_admin_revoke' => 'Admin - Intrekking',
    'stat_page_admin_logout' => 'Admin - Uitloggen',
    'stat_page_superadmin_request_access' => 'Super Admin - Toegangsaanvraag',
    'stat_page_superadmin_poll' => 'Super Admin - Vernieuwing',
    'stat_page_superadmin_logout' => 'Super Admin - Uitloggen',
