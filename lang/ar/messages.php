...
return [
    ...
    'home_meta_description' => 'تبادل آمن للبيانات السرية عبر رابط ذاتي التدمير. كلمات المرور ومفاتيح API والملفات — تشفير من طرف إلى طرف، الخادم لا يرى شيئاً.',
    ...
    'feature_hosted_eu' => 'مستضاف في فرنسا، خاضع للقانون الأوروبي',
    'feature_no_tracking' => 'بدون ملفات تعريف ارتباط لجهات خارجية، بدون خدمات تتبع',
    'feature_hosted_no_tracking' => 'مستضاف في فرنسا، بدون خدمات تتبع',
    ...
    'how_it_works_meta_description' => 'اكتشف كيف يضمن Secret Drop تبادلاً آمناً للبيانات السرية من خلال التشفير من طرف إلى طرف. الخادم لا يرى أسرارك بنص واضح أبداً.',
    ...
    'faq_a5' => 'يُنشئ متصفحك مفتاحاً عشوائياً ويشفر المحتوى محلياً (AES-256-GCM عبر Web Crypto API). الخادم يستقبل فقط بيانات مشفرة — لا يرى المحتوى الواضح أبداً.',
    ...
    'faq_a12' => 'إذا قدمت بريدك الإلكتروني، يمكنك إلغاء أو تمديد أسرارك عبر رابط :manage_link أسفل كل صفحة. ستتلقى رابطاً للاستخدام مرة واحدة صالحاً لمدة 10 دقائق — رابط سحري، بدون كلمة مرور. لا شيء للسرقة، لا شيء للاختراق.',
    ...
    'use_cases_intro' => 'كل يوم، تنتقل كلمات المرور بنص واضح عبر البريد الإلكتروني وSlack والرسائل النصية. إليك كيف يستبدل Secret Drop هذه العادات الخطرة.',
