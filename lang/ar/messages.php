...
return [
    // App
    'app_description' => 'شارك كلمات المرور والملفات السرية دون كشفها. تشفير من طرف إلى طرف. تدمير ذاتي. الخادم لا يرى شيئاً.',
    ...
    // Features
    'feature_encryption' => 'مشفّر في متصفحك — قبل إرسال أي شيء',
    'feature_zero_knowledge' => 'آمن بالتصميم: غير قابل للقراءة، حتى بالنسبة لنا',
    'feature_auto_destroy' => 'أنت تقرر متى يتم تدميره ذاتياً',
    'feature_expiration' => 'بدون حساب، بدون كلمة مرور: لا شيء لاختراقه',
    ...
    'faq_a4' => 'بمجرد الوصول إلى حد القراءة، يتم تدمير المحتوى المشفر نهائياً على الخادم. يتم الاحتفاظ فقط بالبيانات الوصفية (تاريخ الإنشاء، عدد القراءات) كدليل على وجود السر واستهلاكه. حتى لو اعترض شخص ما الرابط والمفتاح، فإن السر لم يعد موجوداً — لا يوجد شيء لفك تشفيره.',
    ...
    'faq_a12' => 'إذا قدمت بريدك الإلكتروني عند الإنشاء، يمكنك إدارة أسرارك (إلغاء، تمديد) عبر رابط "إدارة". أدخل بريدك الإلكتروني وستتلقى رابطاً للاستخدام مرة واحدة صالحاً لمدة 10 دقائق. هذا الرابط السحري هو خيار أمني مدروس: عدم وجود كلمة مرور يعني عدم وجود شيء للسرقة أو التسريب أو الاختراق. بريدك الإلكتروني يصبح عامل المصادقة الوحيد — بسيط وآمن.',
    ...
    'sbd_zk_title' => 'المعرفة الصفرية: استحالة رياضية، ليست وعداً',
    'sbd_zk_desc' => 'الخادم لا يتلقى مفتاح التشفير أبداً. حتى لو تم اختراق قاعدة البيانات، لن يحصل المهاجم إلا على نص مشفر عديم الفائدة. هذه ليست سياسة خصوصية — إنها استحالة رياضية.',
    'sbd_ml_title' => 'الروابط السحرية: القضاء على ناقل هجوم كلمات المرور',
    'sbd_ml_desc' => 'عدم وجود كلمة مرور يعني عدم وجود شيء للسرقة أو التسريب أو الاختراق. بريدك الإلكتروني هو عامل المصادقة الوحيد. قاعدة بيانات مخترقة لا تكشف عن بيانات اعتماد، لأنها غير موجودة.',
    'sbd_fragment_title' => 'جزء URL: المفتاح لا يلمس الخادم أبداً',
    'sbd_fragment_desc' => 'مفتاح فك التشفير موجود في جزء URL (#). بحكم تصميم بروتوكول HTTP، لا يتم إرسال هذا الجزء إلى الخادم أبداً — لا في الطلبات ولا في السجلات ولا في أي مكان.',
    'sbd_destroy_title' => 'التدمير الذاتي: تقليل التعرض',
    'sbd_destroy_desc' => 'السر الذي تمت قراءته لم يعد موجوداً. الانتهاء القابل للتكوين وخيار الاستخدام الواحد يقللان نافذة التعرض إلى الحد الأدنى.',
