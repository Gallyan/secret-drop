...
return [
    ...
    'home_meta_description' => 'شارك كلمة مرور أو مفتاح API أو ملفاً سرياً عبر رابط يدمّر نفسه تلقائياً. يشفّره متصفحك، فلا يرى الخادم المحتوى أبداً.',
    'home_answer_target' => 'يشفّر Secret Drop كلمات المرور والملفات السرية في متصفحك قبل إرسالها. يخزّن الخادم بيانات غير قابلة للقراءة فقط، ولا يملك أي وسيلة للوصول إلى المحتوى. يدمّر كل سر نفسه تلقائياً عند انتهاء صلاحيته أو بلوغه حد القراءة. مجاني، بدون حساب، بدون تتبع.',
    ...
    'text_too_large' => 'النص طويل جداً (الحد الأقصى 50 كيلوبايت)',
    ...
    'how_it_works_intro' => 'تبقى كلمة المرور التي ترسلها عبر البريد الإلكتروني أو Slack قابلة للقراءة في صناديق البريد والنسخ الاحتياطية وسجلات المحادثات لكل خدمة تمر بها. يشفّر Secret Drop بياناتك السرية في متصفحك قبل إرسالها، فلا يستقبل الخادم سوى بيانات لا يستطيع قراءتها.',
    ...
    'how_step2_desc' => 'ينشئ متصفحك مفتاحاً عشوائياً ويشفر المحتوى محلياً باستخدام <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a> عبر <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>.',
    'how_step3_title' => 'الخادم يخزن البيانات المشفرة',
    'how_step3_desc' => 'يخزّن الخادم البيانات المشفرة بدون المفتاح، لذا لا يملك أي وسيلة لفك تشفيرها.',
    'how_step4_title' => 'المفتاح يبقى في الرابط',
    'how_step4_desc' => 'يضع متصفحك مفتاح فك التشفير في جزء الرابط (بعد #). لا ترسل المتصفحات هذا الجزء إلى الخادم أبداً.',
    ...
    'how_step6_desc' => 'عندما يبلغ السر حد القراءة أو تاريخ انتهاء صلاحيته، يحذف الخادم المحتوى المشفر نهائياً. لا يبقى سوى أثر لوجوده، ولا شيء يمكن فك تشفيره.',
    ...
    'how_feature4_desc' => 'تنتهي صلاحية كل سر بعد المدة التي تختارها، ويمكنك تحديده بقراءة واحدة. بعد ذلك يحذف الخادم المحتوى نهائياً.',
    ...
    'faq_a1' => 'نعم. بدون حساب، بدون اشتراك، بدون رسوم خفية.',
    'faq_q2' => 'هل أحتاج إلى حساب؟',
    'faq_a2' => 'لا. بدون تسجيل، بدون تتبع. ما لم تُدخل بريداً إلكترونياً لإدارة أسرارك، لا شيء يربطها بك.',
    'faq_q3' => 'كيف أشارك كلمة مرور بأمان؟',
    'faq_a3' => 'الصق كلمة المرور، واختر مدة الصلاحية، وحدّدها بقراءة واحدة إن أردت. يشفّرها Secret Drop في متصفحك ويمنحك رابطاً آمناً للمشاركة.',
    'faq_q4' => 'ما هو الحجم الأقصى للملفات؟',
    'faq_a4' => 'حتى 10 ميغابايت للملفات و50,000 حرف للرسائل. يشفّر متصفحك الملفات قبل رفعها.',
    'faq_q5' => 'كيف تُشفر بياناتي؟',
    'faq_a5' => 'يُنشئ متصفحك مفتاحاً عشوائياً ويشفر المحتوى محلياً باستخدام <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a>، الخوارزمية الموصى بها من NIST، عبر <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a> من W3C. لا يستقبل الخادم سوى بيانات مشفرة، ولا يرى المحتوى الواضح أبداً.',
    'faq_q6' => 'هل يستطيع الخادم قراءة أسراري؟',
    'faq_a6' => 'لا. يبقى مفتاح فك التشفير في جزء URL (بعد #)، ولا ترسل المتصفحات هذا الجزء إلى الخادم أبداً. بدون المفتاح، لا يملك الخادم أي وسيلة لفك تشفير أسرارك.',
    'faq_q7' => 'ماذا يحدث بعد القراءة؟',
    'faq_a7' => 'عندما يبلغ السر حد القراءة، يحذف الخادم المحتوى المشفر نهائياً ولا يحتفظ إلا بأثر لوجوده. إذا اعترض أحد الرابط بعد ذلك، فلن يجد شيئاً لفك تشفيره. وإذا لم يُحدَّد حد للقراءة، يبقى السر متاحاً حتى انتهاء صلاحيته.',
    'faq_q8' => 'أين تُخزن البيانات؟',
    'faq_a8' => 'على خوادم في فرنسا. يخزّن الخادم البيانات المشفرة فقط، ولا يصل أبداً إلى المحتوى الواضح.',
    'faq_q9' => 'هل Secret Drop متوافق مع GDPR؟',
    'faq_a9' => 'نعم، بالتصميم. تشفير المعرفة الصفرية، بدون تتبع، بدون ملفات تعريف ارتباط إعلانية، حذف تلقائي للبيانات منتهية الصلاحية. لا يخزّن Secret Drop أي بيانات شخصية بنص واضح.',
    ...
    'secure_by_design_intro' => 'كل خيار معماري أدناه يحدّ مما يمكن للمهاجم الوصول إليه، ومما يمكننا نحن الوصول إليه.',
    'sbd_zk_title' => 'المعرفة الصفرية',
    'sbd_zk_desc' => 'لا يتلقى الخادم مفتاح التشفير أبداً، وفقاً لمبادئ <a href="https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">التخزين التشفيري OWASP</a>. المهاجم الذي يسرق قاعدة البيانات لا يحصل إلا على بيانات مشفرة لا يستطيع فك تشفيرها.',
    'sbd_ml_title' => 'مصادقة بدون كلمة مرور',
    'sbd_ml_desc' => 'رابط سحري للاستخدام مرة واحدة يحل محل كلمة المرور. لا تخزّن قاعدة البيانات أي بيانات اعتماد، لذا لا يجد المهاجم الذي يسرقها شيئاً ليكسره.',
    'sbd_fragment_title' => 'المفتاح لا يغادر جهازك أبداً',
    'sbd_fragment_desc' => 'يوجد مفتاح فك التشفير في جزء URL (بعد #). لا ترسل المتصفحات هذا الجزء إلى الخادم أبداً، لذا لا يظهر المفتاح في الطلبات ولا في سجلات الخادم.',
    'sbd_destroy_title' => 'تدمير نهائي',
    'sbd_destroy_desc' => 'عندما يبلغ السر حد القراءة أو تنتهي صلاحيته، يحذف الخادم المحتوى المشفر ولا يحتفظ إلا بأثر لوجوده. تقصير مدة الصلاحية وتحديد حد للقراءة يقلّصان المدة التي يبقى فيها سرك معرّضاً.',
    'sbd_hosted_title' => 'مستضاف في فرنسا',
    'sbd_hosted_desc' => 'خوادمنا في فرنسا، تحت الولاية القضائية للاتحاد الأوروبي. تخضع بياناتك للائحة العامة لحماية البيانات (GDPR) وتبقى داخل الاتحاد الأوروبي، دون أي نقل إلى دول خارجية.',
    'sbd_notrack_title' => 'بدون تتبع',
    'sbd_notrack_desc' => 'لا ملفات تعريف ارتباط لجهات خارجية، ولا بكسلات تتبع، ولا خدمات خارجية. لا نشارك أي بيانات مع أطراف ثالثة، ولا نحلّل نشاطك على هذا الموقع أو نبيعه.',
    ...
    'use_cases_meta_description' => 'كيف تشارك كلمات المرور والمستندات الحساسة ومفاتيح API وغيرها من البيانات السرية عبر رابط مشفر يدمّر نفسه تلقائياً.',
    'use_cases_intro' => 'ترسل الفرق كل يوم كلمات المرور والعقود ومفاتيح API بنص واضح عبر البريد الإلكتروني وSlack والرسائل النصية. يتيح لك Secret Drop إرسالها عبر رابط مشفر من طرف إلى طرف.',
    'usecase1_title' => 'كلمات المرور وبيانات الاعتماد',
    'usecase1_desc' => 'عضو جديد في الفريق يحتاج إلى وصول. بدلاً من بريد إلكتروني يبقى قابلاً للقراءة في صندوقي البريد، أرسل رابطاً يدمّر نفسه بعد القراءة.',
    'usecase1_example' => 'الوصول إلى نظام إدارة المحتوى، حسابات مشتركة، بيانات Wi-Fi لمتعاقد.',
    'usecase1_tip' => 'اضبط انتهاء الصلاحية على ساعة واحدة وقراءة واحدة. غيّر كلمة المرور إذا لم يفتح المستلم الرابط في الوقت المحدد.',
    ...
    'usecase3_desc' => 'مفتاح API الملصق في قناة Slack يبقى قابلاً للقراءة بنص واضح لكل أعضائها. الرابط المخصص للاستخدام مرة واحدة يتوقف عن العمل بمجرد أن يفتحه المستلم.',
    ...
    'usecase5_desc' => 'شارك كلمة مرور الـ Wi-Fi بدون كتابتها على ورقة لاصقة. يمسح ضيوفك رمز QR المدمج لفتح الرابط على هواتفهم.',
    ...
    'use_cases_tip2' => 'اضبط حد القراءة على 1 حتى لا يتمكن المستلم من قراءة السر إلا مرة واحدة.',
    ...
    'legal_about_text' => 'Secret Drop بديل مجاني ومفتوح المصدر لإرسال كلمات المرور والملفات الحساسة عبر البريد الإلكتروني أو تطبيقات المراسلة، مصمَّم لاحترام خصوصيتك. يمكن لأي شخص قراءة الكود المصدري وتدقيقه.',
    'legal_about_security' => 'بفضل بنية المعرفة الصفرية، لا يملك الخادم أي وسيلة للوصول إلى محتوى أسرارك. ينفّذ متصفحك تشفير AES-256-GCM ولا يرسل مفتاح فك التشفير إلى الخادم أبداً.',
    ...
    'legal_cookies_text' => 'يستخدم هذا الموقع فقط ملفات تعريف الارتباط التقنية الأساسية (الجلسة، تفضيل السمة). ولا يستخدم أي ملفات تعريف ارتباط للتتبع أو الإعلان.',
    ...
    'stat_page_admin_poll' => 'المشرف - تحديث',
    'stat_page_admin_extend' => 'المشرف - تمديد',
    'stat_page_admin_revoke' => 'المشرف - إلغاء',
    'stat_page_admin_logout' => 'المشرف - تسجيل الخروج',
    'stat_page_superadmin_request_access' => 'المشرف العام - طلب الوصول',
    'stat_page_superadmin_poll' => 'المشرف العام - تحديث',
    'stat_page_superadmin_logout' => 'المشرف العام - تسجيل الخروج',
