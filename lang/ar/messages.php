...
return [
    ...
    'max_security_tooltip' => 'يُهيئ تلقائياً: عرض واحد، انتهاء 1 ساعة، ووضع منفصل (رابط + مفتاح). يمكنك تعديل هذه الخيارات لاحقاً.',
    ...
    'how_it_works_meta_description' => 'اكتشف كيف يحمي Secret Drop بياناتك بالتشفير من طرف إلى طرف. الخادم لا يرى أسرارك بشكل نصي أبداً.',
    'how_it_works_intro' => 'يستخدم Secret Drop التشفير من طرف إلى طرف (E2E) لضمان أن المستلم فقط يمكنه قراءة أسرارك. يخزن الخادم البيانات المشفرة فقط ولا يملك أبداً الوصول إلى المحتوى النصي.',
    ...
    'how_step3_title' => 'الخادم يخزن النص المشفر',
    ...
    'usecase2_example' => 'مثال: إرسال هوية إلى بنك، نقل عقد موقع.',
    ...
    'usecase3_example' => 'مثال: مشاركة مفتاح Stripe مع متعاقد، نقل متغيرات البيئة.',
