...
return [
    ...
    // Features
    'feature_encryption' => 'تشفير AES-256-GCM في متصفحك',
    ...
    'passphrase_hint' => 'يضيف طبقة أمان. المستلم يحتاجها لفك التشفير. لا تُرسل أبداً للخادم.',
    ...
    'btn_cancel' => 'إلغاء',
    'btn_download_again' => 'تحميل مرة أخرى',
    ...
    'crypto_passphrase_incorrect' => 'عبارة المرور غير صحيحة أو البيانات تالفة',
    ...
    'legal_data_not_item_key' => 'مفاتيح التشفير (تُنقل فقط عبر جزء URL)',
