...
return [
    ...
    'how_it_works_intro' => 'عندما تشارك كلمة مرور عبر البريد الإلكتروني أو Slack، تظل قابلة للقراءة من قبل كل وسيط. Secret Drop يفعل العكس: سرّك يُشفَّر في متصفحك قبل أن يغادر شاشتك. الخادم لا يستقبل سوى ضوضاء.',
    ...
    'sbd_zk_desc' => 'الخادم لا يتلقى مفتاح التشفير أبداً. حتى لو تم اختراق قاعدة البيانات، لن يحصل المهاجم إلا على ضوضاء عديمة الفائدة. هذا ليس وعداً — إنه استحالة رياضية.',
