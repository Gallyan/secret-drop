...
return [
    ...
    'faq_a5' => 'Seu navegador gera uma chave aleatória e criptografa o conteúdo localmente (AES-256-GCM via Web Crypto API). O servidor recebe apenas dados criptografados — nunca vê o conteúdo em texto simples.',
    ...
    'sbd_zk_desc' => 'O servidor nunca recebe a chave de criptografia. Mesmo com o banco de dados comprometido, um invasor obtém apenas ruído inútil. Não é uma promessa — é uma impossibilidade matemática.',
