...
return [
    ...
    'faq_a6' => 'Możesz udostępniać pliki do 10 MB i wiadomości tekstowe do 50 000 znaków. Pliki są szyfrowane w przeglądarce przed wysłaniem.',
    'faq_q7' => 'Gdzie przechowywane są dane?',
    'faq_a7' => 'Wszystkie dane są przechowywane na serwerach zlokalizowanych we Francji. Przechowywane są wyłącznie zaszyfrowane dane — serwer nigdy nie ma dostępu do jawnej treści Twoich sekretów.',
    'faq_q8' => 'Czy Secret Drop jest zgodny z RODO?',
    'faq_a8' => 'Tak, z założenia. Secret Drop wykorzystuje szyfrowanie zero-knowledge, nie śledzi użytkowników, nie używa reklamowych plików cookie i automatycznie usuwa wygasłe dane. Żadne dane osobowe nie są przechowywane w postaci jawnej.',
