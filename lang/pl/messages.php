...
return [
    ...
    'home_meta_description' => 'Udostępnij hasło, klucz API lub poufny plik przez samozniszczalny link. Twoja przeglądarka szyfruje treść, więc serwer nigdy jej nie widzi.',
    'home_answer_target' => 'Secret Drop szyfruje Twoje hasła i poufne pliki w przeglądarce, zanim je wyśle. Serwer przechowuje wyłącznie nieczytelne dane i nie ma żadnej możliwości dostępu do treści. Każdy sekret ulega samozniszczeniu, gdy wygaśnie lub osiągnie limit odczytów. Bezpłatne, bez konta, bez śledzenia.',
    ...
    'text_too_large' => 'Tekst jest za długi (maks. 50 000 znaków)',
    ...
    'how_it_works_intro' => 'Hasło wysłane e-mailem lub przez Slacka pozostaje czytelne w skrzynkach, kopiach zapasowych i historiach każdej usługi, przez którą przechodzi. Secret Drop szyfruje Twoje poufne dane w przeglądarce przed wysłaniem, więc serwer otrzymuje tylko dane, których nie potrafi odczytać.',
    ...
    'how_step2_desc' => 'Twoja przeglądarka generuje losowy klucz i szyfruje treść lokalnie za pomocą <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a> poprzez <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>.',
    'how_step3_title' => 'Serwer przechowuje zaszyfrowane dane',
    'how_step3_desc' => 'Serwer zapisuje zaszyfrowane dane bez klucza, więc nie ma jak ich odszyfrować.',
    'how_step4_title' => 'Klucz pozostaje w URL',
    'how_step4_desc' => 'Twoja przeglądarka umieszcza klucz deszyfrujący we fragmencie URL (po #). Przeglądarki nigdy nie wysyłają tej części na serwer.',
    ...
    'how_step6_desc' => 'Gdy sekret osiągnie limit odczytów lub datę wygaśnięcia, serwer trwale usuwa zaszyfrowaną treść. Pozostaje jedynie ślad jego istnienia, bez niczego do odszyfrowania.',
    'how_security_title' => 'Czym jest szyfrowanie zero-knowledge?',
    'how_feature1_title' => 'Zero-knowledge',
    'how_feature1_desc' => 'Serwer nie ma żadnej możliwości odczytania Twoich sekretów. Jeśli sąd nakaże nam wydanie danych, możemy przekazać tylko zaszyfrowaną treść, której sami nie potrafimy odszyfrować.',
    'how_feature2_title' => 'Szyfrowanie wojskowe',
    'how_feature2_desc' => 'NIST ustandaryzował AES-256-GCM, a NSA zatwierdza AES-256 do ochrony informacji niejawnych do poziomu Top Secret włącznie.',
    'how_feature3_title' => 'Bez konta',
    'how_feature3_desc' => 'Bez rejestracji, bez śledzenia. Jeśli nie podasz adresu e-mail do zarządzania sekretami, nic nie łączy ich z Tobą.',
    'how_feature4_title' => 'Autodestrukcja',
    'how_feature4_desc' => 'Każdy sekret wygasa po wybranym przez Ciebie czasie, a do tego możesz ograniczyć go do jednego odczytu. Następnie serwer trwale usuwa treść.',
    ...
    'faq_a1' => 'Tak. Bez konta, bez subskrypcji, bez ukrytych opłat.',
    'faq_q2' => 'Czy potrzebuję konta?',
    'faq_a2' => 'Nie. Bez rejestracji, bez śledzenia. Jeśli nie podasz adresu e-mail do zarządzania sekretami, nic nie łączy ich z Tobą.',
    'faq_q3' => 'Jak bezpiecznie udostępnić hasło?',
    'faq_a3' => 'Wklej hasło, wybierz czas wygaśnięcia i, jeśli chcesz, ogranicz je do jednego odczytu. Secret Drop zaszyfruje je w przeglądarce i da Ci bezpieczny link do udostępnienia.',
    'faq_q4' => 'Jaki jest maksymalny rozmiar pliku?',
    'faq_a4' => 'Do 10 MB dla plików i 50 000 znaków dla wiadomości. Twoja przeglądarka szyfruje pliki przed wysłaniem.',
    'faq_q5' => 'Jak szyfrowane są moje dane?',
    'faq_a5' => 'Przeglądarka generuje losowy klucz i szyfruje treść lokalnie za pomocą <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a>, algorytmu zalecanego przez NIST, poprzez <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a> W3C. Serwer otrzymuje tylko zaszyfrowane dane i nigdy nie widzi treści w postaci jawnej.',
    'faq_q6' => 'Czy serwer może odczytać moje sekrety?',
    'faq_a6' => 'Nie. Klucz deszyfrujący pozostaje we fragmencie URL (po #), a przeglądarki nigdy nie wysyłają fragmentu na serwer. Bez klucza serwer nie ma jak odszyfrować Twoich sekretów.',
    'faq_q7' => 'Co się dzieje po odczytaniu?',
    'faq_a7' => 'Gdy sekret osiągnie limit odczytów, serwer trwale usuwa zaszyfrowaną treść i zachowuje jedynie ślad jego istnienia. Jeśli ktoś przechwyci link później, nie znajdzie niczego do odszyfrowania. Bez limitu odczytów sekret pozostaje dostępny do momentu wygaśnięcia.',
    'faq_q8' => 'Gdzie przechowywane są dane?',
    'faq_a8' => 'Na serwerach zlokalizowanych we Francji. Serwer przechowuje wyłącznie zaszyfrowane dane i nigdy nie ma dostępu do treści jawnej.',
    'faq_q9' => 'Czy Secret Drop jest zgodny z RODO?',
    'faq_a9' => 'Tak, z założenia. Szyfrowanie zero-knowledge, brak śledzenia, brak ciasteczek reklamowych, automatyczne usuwanie wygasłych danych. Secret Drop nie przechowuje żadnych danych osobowych w postaci jawnej.',
    ...
    'secure_by_design_intro' => 'Każda z poniższych decyzji architektonicznych ogranicza to, do czego mógłby dotrzeć atakujący, i to, do czego sami mamy dostęp.',
    'sbd_zk_title' => 'Zero-knowledge',
    'sbd_zk_desc' => 'Serwer nigdy nie otrzymuje klucza szyfrowania, zgodnie z zasadami <a href="https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">przechowywania kryptograficznego OWASP</a>. Atakujący, który ukradnie bazę danych, dostaje tylko zaszyfrowane dane, których nie potrafi odszyfrować.',
    'sbd_ml_title' => 'Uwierzytelnianie bez hasła',
    'sbd_ml_desc' => 'Jednorazowy magic link zastępuje hasło. Baza danych nie przechowuje żadnych danych logowania, więc atakujący, który ją ukradnie, nie ma czego łamać.',
    'sbd_fragment_title' => 'Klucz nigdy nie opuszcza Twojego urządzenia',
    'sbd_fragment_desc' => 'Klucz deszyfrujący znajduje się we fragmencie URL (po #). Przeglądarki nigdy nie wysyłają fragmentu na serwer, więc klucz nie pojawia się ani w żądaniach, ani w logach serwera.',
    'sbd_destroy_title' => 'Trwałe zniszczenie',
    'sbd_destroy_desc' => 'Gdy sekret osiągnie limit odczytów lub wygaśnie, serwer usuwa zaszyfrowaną treść i zachowuje jedynie ślad jego istnienia. Krótki czas wygaśnięcia i limit odczytów skracają czas, przez który Twój sekret pozostaje narażony.',
    'sbd_hosted_title' => 'Hostowane we Francji',
    'sbd_hosted_desc' => 'Nasze serwery znajdują się we Francji, pod jurysdykcją Unii Europejskiej. Twoje dane podlegają RODO i pozostają w UE, bez transferu do państw trzecich.',
    'sbd_notrack_title' => 'Brak śledzenia',
    'sbd_notrack_desc' => 'Bez ciasteczek stron trzecich, pikseli śledzących i zewnętrznych serwisów. Nie udostępniamy żadnych danych podmiotom trzecim, nie profilujemy ani nie sprzedajemy Twojej aktywności na tej stronie.',
    ...
    'use_cases_meta_description' => 'Jak udostępniać hasła, wrażliwe dokumenty, klucze API i inne poufne dane przez szyfrowany, samozniszczalny link.',
    'use_cases_intro' => 'Zespoły codziennie wysyłają hasła, umowy i klucze API otwartym tekstem przez e-mail, Slack lub SMS. Secret Drop pozwala wysłać je zamiast tego przez link szyfrowany end-to-end.',
    'usecase1_title' => 'Hasła i dane logowania',
    'usecase1_desc' => 'Nowy członek zespołu potrzebuje dostępu. Zamiast e-maila, który pozostaje czytelny w obu skrzynkach, wyślij link, który ulega samozniszczeniu po odczytaniu.',
    'usecase1_example' => 'Dostęp do CMS, współdzielone konta, dane Wi-Fi dla wykonawcy.',
    'usecase1_tip' => 'Wygaśnięcie 1 godzina, pojedynczy odczyt. Zmień hasło, jeśli odbiorca nie otworzy linku na czas.',
    ...
    'usecase3_desc' => 'Klucz API wklejony na kanale Slack pozostaje czytelny otwartym tekstem dla wszystkich jego członków. Jednorazowy link przestaje działać, gdy tylko odbiorca go otworzy.',
    ...
    'usecase5_desc' => 'Udostępnij hasło do Wi-Fi bez zapisywania go na karteczce. Goście skanują wbudowany kod QR, aby otworzyć link na telefonie.',
    ...
    'usecase6_desc' => 'Numery kart, PIN-y, informacje medyczne: dane, które nie powinny zostawać w historii czatu.',
    ...
    'use_cases_tip2' => 'Ustaw limit odczytów na 1, aby odbiorca mógł odczytać sekret tylko raz.',
    ...
    'legal_about_text' => 'Secret Drop to darmowa alternatywa open source dla wysyłania haseł i wrażliwych plików e-mailem lub przez komunikatory, zaprojektowana z myślą o ochronie Twojej prywatności. Każdy może przeczytać kod źródłowy i przeprowadzić jego audyt.',
    'legal_about_security' => 'Dzięki architekturze zero-knowledge serwer nie ma żadnej możliwości dostępu do treści Twoich sekretów. Twoja przeglądarka wykonuje szyfrowanie AES-256-GCM i nigdy nie przesyła klucza deszyfrowania na serwer.',
    ...
    'legal_data_text' => 'Secret Drop działa zgodnie z zasadą „zero-knowledge”. Twoja przeglądarka szyfruje sekrety przed wysłaniem ich na serwer, który przechowuje tylko zaszyfrowane dane i nie ma dostępu do ich jawnej treści.',
    ...
    'legal_cookies_text' => 'Ta strona używa tylko niezbędnych technicznych plików cookie (sesja, preferencje motywu). Nie używa żadnych plików cookie śledzących ani reklamowych.',
    ...
    'email_storage_quota_subject' => 'Pamięć zapełniona w :percent% - :app',
    ...
    'superadmin_deployed_on' => 'Wdrożono :date',
    ...
    'stat_page_admin_poll' => 'Admin - Odświeżanie',
    'stat_page_admin_extend' => 'Admin - Przedłużenie',
    'stat_page_admin_revoke' => 'Admin - Unieważnienie',
    'stat_page_admin_logout' => 'Admin - Wylogowanie',
    'stat_page_superadmin_request_access' => 'Super Admin - Prośba o dostęp',
    'stat_page_superadmin_poll' => 'Super Admin - Odświeżanie',
    'stat_page_superadmin_logout' => 'Super Admin - Wylogowanie',
    ...
    'val_hours_required' => 'Liczba godzin jest wymagana.',
    'val_hours_integer' => 'Liczba godzin musi być liczbą całkowitą.',
    'val_hours_min' => 'Liczba godzin musi wynosić co najmniej 1.',
    'val_hours_max' => 'Liczba godzin nie może przekraczać 720.',
    ...
    'hint_errors_5xx' => 'Łączna liczba błędów serwera (500-599). Każda wartość powyżej 0 oznacza błąd lub problem z infrastrukturą: od razu sprawdź logi.',
