...
return [
    ...
    'faq_a5' => 'Przeglądarka generuje losowy klucz i szyfruje treść lokalnie (AES-256-GCM przez Web Crypto API). Serwer otrzymuje tylko zaszyfrowane dane — nigdy nie widzi treści w postaci jawnej.',
