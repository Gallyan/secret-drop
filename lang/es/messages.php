...
return [
    ...
    'how_it_works_intro' => 'Secret Drop utiliza cifrado de extremo a extremo (E2E) para garantizar que solo el destinatario pueda leer tus secretos. El servidor solo almacena datos cifrados y nunca tiene acceso al contenido en texto plano.',
    'how_it_works_diagram_title' => 'El proceso de cifrado',
    ...
    'faq_q1' => '¿Cómo cifra Secret Drop mis datos?',
    'faq_a1' => 'Su navegador genera una clave de cifrado aleatoria y cifra su contenido localmente con AES-256-GCM a través de la API Web Crypto. El servidor solo recibe y almacena datos cifrados.',
    'faq_q2' => '¿Puede el servidor leer mis secretos?',
    'faq_a2' => 'No. Secret Drop utiliza una arquitectura de conocimiento cero. La clave de descifrado se coloca en el fragmento de la URL (después de #), que nunca se envía al servidor.',
    ...
    'faq_a6' => 'Puede compartir archivos de hasta 10 MB y mensajes de texto de hasta 50.000 caracteres. Los archivos se cifran en su navegador antes de subirlos.',
    'faq_q7' => '¿Dónde se almacenan los datos?',
    'faq_a7' => 'Todos los datos se almacenan en servidores ubicados en Francia. Solo se conservan datos cifrados — el servidor nunca tiene acceso al contenido en texto plano de sus secretos.',
    'faq_q8' => '¿Es Secret Drop compatible con el RGPD?',
    'faq_a8' => 'Sí, por diseño. Secret Drop utiliza cifrado de conocimiento cero, no rastrea usuarios, no usa cookies publicitarias y elimina automáticamente los datos caducados. No se almacenan datos personales en texto plano.',
    'faq_q9' => '¿Cómo comparto una contraseña de forma segura?',
    'faq_a9' => 'Pegue su contraseña, elija un tiempo de expiración y opcionalmente limite a una sola lectura. Secret Drop la cifra en su navegador y le proporciona un enlace seguro para compartir. La contraseña nunca es visible para el servidor.',
    'faq_q10' => '¿Es Secret Drop de código abierto?',
    'faq_a10' => 'Sí, el código fuente de Secret Drop está disponible públicamente bajo la licencia Business Source License (BSL). Puede inspeccionar la lógica de cifrado, verificar que no hay puertas traseras y confirmar que la arquitectura de conocimiento cero funciona como se describe.',
    ...
    'use_cases_intro' => 'Secret Drop es la herramienta ideal para compartir información sensible de forma segura. Aquí hay algunos ejemplos concretos.',
    'usecase1_title' => 'Cómo compartir una contraseña de forma segura',
    'usecase1_desc' => 'Comparte credenciales de forma segura con colegas, clientes o proveedores sin usar canales inseguros como email o mensajería.',
    'usecase1_example' => 'Ejemplo: Enviar credenciales a un nuevo miembro del equipo, compartir contraseña Wi-Fi con un invitado.',
    'usecase2_title' => 'Documentos confidenciales',
    'usecase2_desc' => 'Envía documentos sensibles (contratos, facturas, documentos de identidad) sin preocuparte por interceptación o almacenamiento en servidores de terceros.',
    'usecase2_example' => 'Ejemplo: Enviar documento de identidad a un banco, transmitir un contrato firmado.',
    'usecase3_title' => 'Claves API y tokens',
    'usecase3_desc' => 'Los desarrolladores pueden compartir claves API, tokens de autenticación o secretos de aplicación de forma segura.',
    'usecase3_example' => 'Ejemplo: Compartir una clave de Stripe con un proveedor, transmitir variables de entorno.',
    'usecase4_title' => 'Claves SSH y certificados',
    'usecase4_desc' => 'Transmite claves SSH privadas o certificados SSL a tus administradores de sistemas de forma segura.',
    'usecase4_example' => 'Ejemplo: Dar acceso temporal al servidor, compartir un certificado de firma.',
    'usecase5_title' => 'Contraseñas Wi-Fi',
    'usecase5_desc' => 'Comparte fácilmente la contraseña de tu red con invitados mediante un código QR seguro.',
    'usecase5_example' => 'Ejemplo: Recibir visitantes en la oficina, compartir acceso a un Airbnb.',
    'usecase6_title' => 'Información personal',
    'usecase6_desc' => 'Transmite datos personales sensibles (números de cuenta, códigos PIN) a familiares de confianza.',
    'usecase6_example' => 'Ejemplo: Compartir número de tarjeta de crédito para una compra, transmitir códigos de acceso en caso de emergencia.',
    ...
    'use_cases_cta' => 'Crear un secreto ahora',
