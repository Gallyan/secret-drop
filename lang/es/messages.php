...
return [
    ...
    'how_step2_desc' => 'Tu navegador genera una clave aleatoria y cifra el contenido localmente con <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a> a través de la <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>. El servidor solo recibe datos cifrados.',
    ...
    'faq_a12' => 'Si proporcionó su email, puede revocar o extender sus secretos a través del enlace :manage_link al pie de cada página. Recibirá un enlace de uso único válido por :minutes minutos — un magic link, sin contraseña. Nada que robar, nada que hackear.',
    ...
    'sbd_zk_desc' => 'El servidor nunca recibe la clave de cifrado — siguiendo los principios de <a href="https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">almacenamiento criptográfico OWASP</a>. Incluso si la base de datos es comprometida, un atacante solo obtiene ruido inútil. No es una promesa — es una imposibilidad matemática.',
    ...
    'sbd_hosted_desc' => 'Infraestructura alojada en Francia, bajo jurisdicción de la Unión Europea. Sus datos están protegidos por el RGPD y nunca salen de la UE. Sin transferencia a terceros países, sin excepción.',
    'sbd_notrack_title' => 'Sin rastreo',
    'sbd_notrack_desc' => 'Sin cookies de terceros, sin píxeles de seguimiento, sin servicios externos. Ningún dato se comparte con terceros. Su actividad en este sitio no es perfilada, vendida ni monetizada.',
    ...
    'use_cases_meta_description' => 'Intercambio seguro de datos confidenciales para cada situación: contraseñas, documentos sensibles, claves API y más.',
    'use_cases_intro' => 'Cada día, datos confidenciales viajan en texto plano por email, Slack o SMS. Secret Drop los reemplaza por un intercambio seguro, cifrado de extremo a extremo.',
    ...
    'usecase1_tip' => 'Expiración 1 hora, lectura única. Cambie la contraseña si el enlace no se abrió a tiempo.',
