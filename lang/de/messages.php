...
return [
    ...
    'home_meta_description' => 'Teilen Sie Passwort, API-Schlüssel oder vertrauliche Datei über einen selbstzerstörenden Link. Ihr Browser verschlüsselt die Daten, der Server sieht den Inhalt nie.',
    'home_answer_target' => 'Secret Drop verschlüsselt Ihre Passwörter und vertraulichen Dateien in Ihrem Browser, bevor es sie sendet. Der Server speichert nur unlesbare Daten und hat keine Möglichkeit, auf den Inhalt zuzugreifen. Jedes Geheimnis zerstört sich selbst, sobald es abläuft oder sein Leselimit erreicht. Kostenlos, ohne Konto, ohne Tracker.',
    ...
    'text_too_large' => 'Der Text ist zu lang (max. 50.000 Zeichen)',
    ...
    'how_it_works_intro' => 'Ein Passwort, das Sie per E-Mail oder Slack senden, bleibt in den Postfächern, Backups und Chatverläufen jedes Dienstes lesbar, den es durchläuft. Secret Drop verschlüsselt Ihre vertraulichen Daten in Ihrem Browser vor dem Senden, sodass der Server nur Daten erhält, die er nicht lesen kann.',
    ...
    'how_step2_desc' => 'Ihr Browser generiert einen zufälligen Schlüssel und verschlüsselt den Inhalt lokal mit <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a> über die <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>.',
    'how_step3_title' => 'Server speichert verschlüsselte Daten',
    'how_step3_desc' => 'Der Server speichert die verschlüsselten Daten ohne den Schlüssel und hat daher keine Möglichkeit, sie zu entschlüsseln.',
    'how_step4_title' => 'Schlüssel bleibt in der URL',
    'how_step4_desc' => 'Ihr Browser legt den Entschlüsselungsschlüssel im URL-Fragment (nach dem #) ab. Browser senden diesen Teil nie an den Server.',
    ...
    'how_step6_desc' => 'Sobald das Geheimnis sein Leselimit oder sein Ablaufdatum erreicht, löscht der Server den verschlüsselten Inhalt dauerhaft. Es bleibt nur eine Spur seiner Existenz, ohne etwas zu entschlüsseln.',
    'how_security_title' => 'Was ist Zero-Knowledge-Verschlüsselung?',
    'how_feature1_title' => 'Zero-Knowledge',
    'how_feature1_desc' => 'Der Server hat keine Möglichkeit, Ihre Geheimnisse zu lesen. Verlangt ein Gericht Daten von uns, können wir nur verschlüsselte Inhalte herausgeben, die wir selbst nicht entschlüsseln können.',
    'how_feature2_title' => 'Militärische Verschlüsselung',
    'how_feature2_desc' => 'Das NIST hat AES-256-GCM standardisiert, und die NSA lässt AES-256 für den Schutz von Informationen bis zur Geheimhaltungsstufe Top Secret zu.',
    'how_feature3_title' => 'Kein Konto erforderlich',
    'how_feature3_desc' => 'Keine Registrierung, kein Tracking. Solange Sie keine E-Mail-Adresse zur Verwaltung angeben, verbindet nichts Ihre Geheimnisse mit Ihnen.',
    'how_feature4_title' => 'Automatische Zerstörung',
    'how_feature4_desc' => 'Jedes Geheimnis läuft nach der von Ihnen gewählten Dauer ab, und Sie können es auf einen einzigen Lesevorgang begrenzen. Der Server löscht den Inhalt danach dauerhaft.',
    ...
    'faq_a1' => 'Ja. Kein Konto, kein Abonnement, keine versteckten Kosten.',
    'faq_q2' => 'Brauche ich ein Konto?',
    'faq_a2' => 'Nein. Keine Registrierung, kein Tracking. Solange Sie keine E-Mail-Adresse zur Verwaltung angeben, verbindet nichts Ihre Geheimnisse mit Ihnen.',
    'faq_q3' => 'Wie teile ich ein Passwort sicher?',
    'faq_a3' => 'Fügen Sie Ihr Passwort ein, wählen Sie eine Ablaufzeit und begrenzen Sie es bei Bedarf auf einen einzigen Lesevorgang. Secret Drop verschlüsselt es in Ihrem Browser und gibt Ihnen einen sicheren Link zum Teilen.',
    'faq_q4' => 'Wie groß dürfen Dateien sein?',
    'faq_a4' => 'Bis zu 10 MB für Dateien und 50.000 Zeichen für Nachrichten. Ihr Browser verschlüsselt Dateien vor dem Upload.',
    'faq_q5' => 'Wie werden meine Daten verschlüsselt?',
    'faq_a5' => 'Ihr Browser generiert einen zufälligen Schlüssel und verschlüsselt den Inhalt lokal mit <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a>, dem vom NIST empfohlenen Algorithmus, über die <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a> des W3C. Der Server empfängt nur verschlüsselte Daten und sieht nie den Klartext.',
    'faq_q6' => 'Kann der Server meine Geheimnisse lesen?',
    'faq_a6' => 'Nein. Der Entschlüsselungsschlüssel bleibt im URL-Fragment (nach dem #), und Browser senden das Fragment nie an den Server. Ohne den Schlüssel hat der Server keine Möglichkeit, Ihre Geheimnisse zu entschlüsseln.',
    'faq_q7' => 'Was passiert nach dem Lesen?',
    'faq_a7' => 'Sobald das Geheimnis sein Leselimit erreicht, löscht der Server den verschlüsselten Inhalt dauerhaft und behält nur eine Spur seiner Existenz. Wer den Link danach abfängt, findet nichts zu entschlüsseln. Ohne Leselimit bleibt das Geheimnis bis zu seinem Ablauf verfügbar.',
    'faq_q8' => 'Wo werden die Daten gespeichert?',
    'faq_a8' => 'Auf Servern in Frankreich. Der Server speichert nur verschlüsselte Daten und hat nie Zugriff auf den Klartext.',
    'faq_q9' => 'Ist Secret Drop DSGVO-konform?',
    'faq_a9' => 'Ja, systembedingt. Zero-Knowledge-Verschlüsselung, kein Tracking, keine Werbe-Cookies, automatische Löschung abgelaufener Daten. Secret Drop speichert keine personenbezogenen Daten im Klartext.',
    ...
    'secure_by_design_intro' => 'Jede der folgenden Architekturentscheidungen begrenzt, worauf ein Angreifer zugreifen könnte und worauf wir selbst zugreifen können.',
    'sbd_zk_title' => 'Zero-Knowledge',
    'sbd_zk_desc' => 'Der Server erhält nie den Verschlüsselungsschlüssel, gemäß den <a href="https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">OWASP-Richtlinien für kryptografische Speicherung</a>. Ein Angreifer, der die Datenbank stiehlt, erhält nur verschlüsselte Daten, die er nicht entschlüsseln kann.',
    'sbd_ml_title' => 'Authentifizierung ohne Passwort',
    'sbd_ml_desc' => 'Ein Magic Link zur einmaligen Verwendung ersetzt das Passwort. Die Datenbank speichert keine Zugangsdaten: Ein Angreifer, der sie stiehlt, hat nichts zu knacken.',
    'sbd_fragment_title' => 'Der Schlüssel verlässt Ihr Gerät nie',
    'sbd_fragment_desc' => 'Der Entschlüsselungsschlüssel steht im URL-Fragment (nach dem #). Browser senden das Fragment nie an den Server, daher taucht der Schlüssel weder in Anfragen noch in Server-Logs auf.',
    'sbd_destroy_title' => 'Endgültige Vernichtung',
    'sbd_destroy_desc' => 'Sobald ein Geheimnis sein Leselimit erreicht oder abläuft, löscht der Server den verschlüsselten Inhalt und behält nur eine Spur seiner Existenz. Eine kurze Ablaufzeit und ein Leselimit verkürzen die Zeit, in der Ihr Geheimnis angreifbar bleibt.',
    'sbd_hosted_title' => 'Gehostet in Frankreich',
    'sbd_hosted_desc' => 'Unsere Server stehen in Frankreich, unter der Gerichtsbarkeit der Europäischen Union. Ihre Daten unterliegen der DSGVO und bleiben in der EU, ohne Übermittlung in Drittstaaten.',
    'sbd_notrack_title' => 'Kein Tracking',
    'sbd_notrack_desc' => 'Keine Drittanbieter-Cookies, Tracking-Pixel oder externen Dienste. Wir geben keine Daten an Dritte weiter, erstellen keine Profile Ihrer Aktivität auf dieser Seite und verkaufen sie nicht.',
    ...
    'use_cases_meta_description' => 'So teilen Sie Passwörter, sensible Dokumente, API-Schlüssel und andere vertrauliche Daten über einen verschlüsselten, selbstzerstörenden Link.',
    'use_cases_intro' => 'Teams senden jeden Tag Passwörter, Verträge und API-Schlüssel im Klartext per E-Mail, Slack oder SMS. Mit Secret Drop senden Sie sie stattdessen über einen Ende-zu-Ende-verschlüsselten Link.',
    'usecase1_title' => 'Passwörter und Zugangsdaten',
    'usecase1_desc' => 'Ein neues Teammitglied braucht Zugang. Statt einer E-Mail, die in beiden Postfächern lesbar bleibt, senden Sie einen Link, der sich nach dem Lesen selbst zerstört.',
    'usecase1_example' => 'CMS-Zugang, gemeinsame Konten, WLAN-Zugangsdaten für einen Auftragnehmer.',
    'usecase1_tip' => 'Ablauf 1 Stunde, einmaliges Lesen. Ändern Sie das Passwort, wenn Ihr Empfänger den Link nicht rechtzeitig öffnet.',
    'usecase2_title' => 'Vertrauliche Dokumente',
    'usecase2_desc' => 'Verträge, Ausweisdokumente, Gehaltsabrechnungen: Dateien, die nicht in einem Postfach oder auf einem fremden Server liegen bleiben sollten.',
    ...
    'usecase3_desc' => 'Ein API-Schlüssel, der in einen Slack-Kanal eingefügt wird, bleibt für alle Mitglieder im Klartext lesbar. Ein Einmal-Link funktioniert nicht mehr, sobald Ihr Empfänger ihn öffnet.',
    ...
    'usecase5_desc' => 'Teilen Sie das WLAN-Passwort, ohne es auf einen Zettel zu schreiben. Ihre Gäste scannen den integrierten QR-Code und öffnen den Link auf ihrem Smartphone.',
    ...
    'usecase6_desc' => 'Kartennummern, PINs, medizinische Informationen: Daten, die nicht in einem Chatverlauf bleiben sollten.',
    ...
    'use_cases_tip2' => 'Setzen Sie das Leselimit auf 1, damit Ihr Empfänger das Geheimnis nur ein einziges Mal lesen kann.',
    ...
    'legal_about_text' => 'Secret Drop ist eine kostenlose Open-Source-Alternative zum Versand von Passwörtern und sensiblen Dateien per E-Mail oder Messenger, entwickelt mit Rücksicht auf Ihre Privatsphäre. Jeder kann den Quellcode lesen und prüfen.',
    'legal_about_security' => 'Dank der Zero-Knowledge-Architektur hat der Server keine Möglichkeit, auf den Inhalt Ihrer Geheimnisse zuzugreifen. Ihr Browser führt die AES-256-GCM-Verschlüsselung durch und übermittelt den Entschlüsselungsschlüssel nie an den Server.',
    ...
    'legal_data_text' => 'Secret Drop folgt dem „Zero-Knowledge“-Prinzip. Ihr Browser verschlüsselt Geheimnisse, bevor er sie an den Server sendet. Dieser speichert nur verschlüsselte Daten und kann nicht auf deren Klartext zugreifen.',
    ...
    'legal_cookies_text' => 'Diese Website verwendet nur technisch notwendige Cookies (Sitzung, Theme-Präferenz). Sie verwendet keine Tracking- oder Werbe-Cookies.',
    ...
    'stat_page_admin_poll' => 'Admin - Aktualisierung',
    'stat_page_admin_extend' => 'Admin - Verlängerung',
    'stat_page_admin_revoke' => 'Admin - Widerruf',
    'stat_page_admin_logout' => 'Admin - Abmeldung',
    'stat_page_superadmin_request_access' => 'Super Admin - Zugangsanfrage',
    'stat_page_superadmin_poll' => 'Super Admin - Aktualisierung',
    'stat_page_superadmin_logout' => 'Super Admin - Abmeldung',
