...
return [
    ...
    'faq_a5' => 'Ihr Browser generiert einen zufälligen Schlüssel und verschlüsselt den Inhalt lokal (AES-256-GCM über Web Crypto API). Der Server empfängt nur verschlüsselte Daten — er sieht niemals den Klartext.',
    ...
    'faq_a12' => 'Wenn Sie Ihre E-Mail angegeben haben, können Sie Ihre Geheimnisse über den Link :manage_link am Ende jeder Seite widerrufen oder verlängern. Sie erhalten einen Einmal-Link, gültig für 10 Minuten — einen Magic Link, ohne Passwort. Nichts zu stehlen, nichts zu hacken.',
    ...
    'sbd_zk_desc' => 'Der Server erhält niemals den Verschlüsselungsschlüssel. Selbst bei einem Datenbankeinbruch erhält ein Angreifer nur nutzloses Rauschen. Das ist kein Versprechen — es ist eine mathematische Unmöglichkeit.',
