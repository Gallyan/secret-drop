...
return [
    ...
    'faq_a6' => 'You can share files up to 10 MB and text messages up to 50,000 characters. Files are encrypted in your browser before upload.',
    'faq_q7' => 'Where is the data stored?',
    'faq_a7' => 'All data is stored on servers located in France. Only encrypted data is retained — the server never has access to the plaintext content of your secrets.',
    'faq_q8' => 'Is Secret Drop GDPR compliant?',
    'faq_a8' => 'Yes, by design. Secret Drop uses zero-knowledge encryption, does not track users, does not use advertising cookies, and automatically deletes expired data. No personal data is stored in plaintext.',
    ...
    'usecase1_title' => 'How to securely share a password',
