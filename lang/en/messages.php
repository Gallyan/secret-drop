...
return [
    ...
    'how_step2_desc' => 'Your browser generates a random key and encrypts the content locally with <a href="https://csrc.nist.gov/pubs/sp/800/38d/final" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">AES-256-GCM</a> via the <a href="https://www.w3.org/TR/WebCryptoAPI/" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">Web Crypto API</a>. The server only receives encrypted data.',
    ...
    'sbd_zk_desc' => 'The server never receives the encryption key — following <a href="https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html" target="_blank" rel="noopener" class="text-violet-600 dark:text-violet-400 hover:underline">OWASP cryptographic storage</a> principles. Even if the database is compromised, an attacker only gets useless noise. This is not a promise — it is a mathematical impossibility.',
    ...
    'usecase1_tip' => 'Set expiration to 1 hour, single read. Change the password if the link was not opened in time.',
