    ...
    >
        <div class="py-1.5" x-trap="open">
            <a href="{{ route('home') }}" role="menuitem"
               class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-violet-50 dark:hover:bg-violet-500/10 focus:outline-none focus:bg-violet-50 dark:focus:bg-violet-500/10 transition-colors">
