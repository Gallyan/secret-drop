...
<head>
    ...
    <title>{{ __('messages.email_magic_link_subject') }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>{{ __('messages.email_magic_link_intro') }}</p>

            <p style="text-align: center;">
                <a href="{{ $verifyUrl }}" class="button">{{ __('messages.email_magic_link_button') }}</a>
            </p>
