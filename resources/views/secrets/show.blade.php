        ...
        >
            <div class="p-8 lg:p-12">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-slate-400" x-show="!decrypted && !error">
                    ...
                    <form @submit.prevent="decrypt()" class="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                class="w-full px-4 py-3 bg-slate-900/50 border border-slate-600/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500/50 transition"
                            >
                        </div>
                        <button
                            type="submit"
                ...
                <div x-show="isDecrypting && !needsPassphrase" x-cloak class="text-center py-8">
                    ...
                    <p class="mt-4 text-slate-400">Déchiffrement en cours...</p>
                </div>
                ...
                <div x-show="decrypted" x-cloak class="space-y-6">
                    <div class="relative">
                        <pre
                            x-text="plaintext"
                            class="w-full p-4 bg-slate-900/50 border border-slate-600/50 rounded-xl text-white text-sm font-mono whitespace-pre-wrap break-words max-h-96 overflow-auto"
                        ></pre>
                        <button
                            type="button"
                            @click="copyToClipboard()"
                            class="absolute top-3 right-3 px-3 py-1.5 bg-slate-700/50 hover:bg-slate-600/50 text-slate-300 hover:text-white text-sm font-medium rounded-lg transition"
                        >
                    ...
                    <div x-show="willBeDestroyed" class="p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl">
