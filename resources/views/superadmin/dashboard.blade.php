...
<div class="flex-1 px-4 pt-0 md:p-8 transition-colors">
    <div class="max-w-7xl mx-auto">
        ...
        <nav id="dashboardNav"
             aria-label="{{ __('messages.superadmin_nav_label') }}"
             class="sticky top-22 sm:top-24 z-30 -mx-4 md:-mx-8 px-4 md:px-8 mb-6 border-b border-gray-200 dark:border-slate-700 bg-gray-50/90 dark:bg-slate-900/90 backdrop-blur-sm">
            <ul class="flex items-center gap-1 overflow-x-auto whitespace-nowrap text-sm font-medium scrollbar-thin">
                ...
                @foreach($navSections as $id => $label)
                    <li>
                        <a href="#{{ $id }}"
                           data-nav-target="{{ $id }}"
                           class="dashboard-nav-link inline-flex items-center px-3 py-3 border-b-2 border-transparent text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                            {{ $label }}
                        </a>
                    </li>
                @endforeach
        ...
        <section id="section-activity" aria-labelledby="h-activity" class="scroll-mt-40 mb-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <x-card class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ __('messages.chart_secrets_created') }}</h3>
                    <div class="h-56">
                        <canvas id="secretsCreatedChart" role="img" aria-label="{{ __('messages.chart_secrets_created') }}"></canvas>
                    </div>
                </x-card>
                <x-card class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ __('messages.chart_secrets_read') }}</h3>
                    <div class="h-56">
        ...
        <section id="section-composition" aria-labelledby="h-composition" class="scroll-mt-40 mb-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <x-card class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ __('messages.chart_secret_types') }}</h3>
                    <div class="h-48">
                        <canvas id="secretTypesChart" role="img" aria-label="{{ __('messages.chart_secret_types') }}"></canvas>
                    </div>
                </x-card>
                <x-card class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ __('messages.chart_secret_options') }}</h3>
                    <div class="h-48">
                        <canvas id="secretOptionsChart" role="img" aria-label="{{ __('messages.chart_secret_options') }}"></canvas>
                    </div>
                </x-card>
                <x-card class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ __('messages.chart_secret_outcomes') }}</h3>
                    <div class="h-48">
        ...
        <section id="section-lifecycle" aria-labelledby="h-lifecycle" class="scroll-mt-40 mb-10">
            ...
            <x-card class="p-6 mb-6">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ __('messages.chart_admin_activity') }}</h3>
                <div class="h-56">
        ...
        <section id="section-monitoring" aria-labelledby="h-monitoring" class="scroll-mt-40 mb-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <x-card class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ __('messages.chart_error_trends') }}</h3>
                    <div class="h-56">
                        <canvas id="errorTrendsChart" role="img" aria-label="{{ __('messages.chart_error_trends') }}"></canvas>
                    </div>
                </x-card>
                <x-card class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ __('messages.chart_error_breakdown') }}</h3>
