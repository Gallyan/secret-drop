...
Route::post('/admin/request-access', [AdminController::class, 'requestAccess'])->name('admin.requestAccess');
...
Route::post('/superadmin/request-access', [SuperAdminController::class, 'requestAccess'])->name('superadmin.requestAccess');
